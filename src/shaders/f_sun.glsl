...
void main() {
    ...
    float n = snoise(vec4(vPosition * 0.3, u_time * 0.4));

    //color = random color in range from yellow to red * noise
    vec3 baseColor = mix(vec3(1.0, 0.0, 0.0), vec3(1., .8, 0.0), ln);
