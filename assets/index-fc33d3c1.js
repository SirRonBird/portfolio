...
`].filter(Sr).join(`
`),v=[d,$c(t),"#define SHADER_NAME "+t.shaderName,g,t.useFog&&t.fog?"#define USE_FOG":"",t.useFog&&t.fogExp2?"#define FOG_EXP2":"",t.map?"#define USE_MAP":"",t.matcap?"#define USE_MATCAP":"",t.envMap?"#define USE_ENVMAP":"",t.envMap?"#define "+c:"",t.envMap?"#define "+u:"",t.envMap?"#define "+f:"",h?"#define CUBEUV_TEXEL_WIDTH "+h.texelWidth:"",h?"#define CUBEUV_TEXEL_HEIGHT "+h.texelHeight:"",h?"#define CUBEUV_MAX_MIP "+h.maxMip+".0":"",t.lightMap?"#define USE_LIGHTMAP":"",t.aoMap?"#define USE_AOMAP":"",t.emissiveMap?"#define USE_EMISSIVEMAP":"",t.bumpMap?"#define USE_BUMPMAP":"",t.normalMap?"#define USE_NORMALMAP":"",t.normalMap&&t.objectSpaceNormalMap?"#define OBJECTSPACE_NORMALMAP":"",t.normalMap&&t.tangentSpaceNormalMap?"#define TANGENTSPACE_NORMALMAP":"",t.clearcoat?"#define USE_CLEARCOAT":"",t.clearcoatMap?"#define USE_CLEARCOATMAP":"",t.clearcoatRoughnessMap?"#define USE_CLEARCOAT_ROUGHNESSMAP":"",t.clearcoatNormalMap?"#define USE_CLEARCOAT_NORMALMAP":"",t.iridescence?"#define USE_IRIDESCENCE":"",t.iridescenceMap?"#define USE_IRIDESCENCEMAP":"",t.iridescenceThicknessMap?"#define USE_IRIDESCENCE_THICKNESSMAP":"",t.specularMap?"#define USE_SPECULARMAP":"",t.specularIntensityMap?"#define USE_SPECULARINTENSITYMAP":"",t.specularColorMap?"#define USE_SPECULARCOLORMAP":"",t.roughnessMap?"#define USE_ROUGHNESSMAP":"",t.metalnessMap?"#define USE_METALNESSMAP":"",t.alphaMap?"#define USE_ALPHAMAP":"",t.alphaTest?"#define USE_ALPHATEST":"",t.sheen?"#define USE_SHEEN":"",t.sheenColorMap?"#define USE_SHEENCOLORMAP":"",t.sheenRoughnessMap?"#define USE_SHEENROUGHNESSMAP":"",t.transmission?"#define USE_TRANSMISSION":"",t.transmissionMap?"#define USE_TRANSMISSIONMAP":"",t.thicknessMap?"#define USE_THICKNESSMAP":"",t.decodeVideoTexture?"#define DECODE_VIDEO_TEXTURE":"",t.vertexTangents?"#define USE_TANGENT":"",t.vertexColors||t.instancingColor?"#define USE_COLOR":"",t.vertexAlphas?"#define USE_COLOR_ALPHA":"",t.vertexUvs?"#define USE_UV":"",t.uvsVertexOnly?"#define UVS_VERTEX_ONLY":"",t.gradientMap?"#define USE_GRADIENTMAP":"",t.flatShading?"#define FLAT_SHADED":"",t.doubleSided?"#define DOUBLE_SIDED":"",t.flipSided?"#define FLIP_SIDED":"",t.shadowMapEnabled?"#define USE_SHADOWMAP":"",t.shadowMapEnabled?"#define "+l:"",t.premultipliedAlpha?"#define PREMULTIPLIED_ALPHA":"",t.useLegacyLights?"#define LEGACY_LIGHTS":"",t.logarithmicDepthBuffer?"#define USE_LOGDEPTHBUF":"",t.logarithmicDepthBuffer&&t.rendererExtensionFragDepth?"#define USE_LOGDEPTHBUF_EXT":"","uniform mat4 viewMatrix;","uniform vec3 cameraPosition;","uniform bool isOrthographic;",t.toneMapping!==In?"#define TONE_MAPPING":"",t.toneMapping!==In?Ue.tonemapping_pars_fragment:"",t.toneMapping!==In?oy("toneMapping",t.toneMapping):"",t.dithering?"#define DITHERING":"",t.opaque?"#define OPAQUE":"",Ue.encodings_pars_fragment,sy("linearToOutputTexel",t.outputEncoding),t.useDepthPacking?"#define DEPTH_PACKING "+t.depthPacking:"",`
`].filter(Sr).join(`
`)),a=xa(a),a=qc(a,t),a=Yc(a,t),o=xa(o),o=qc(o,t),o=Yc(o,t),a=Zc(a),o=Zc(o),t.isWebGL2&&t.isRawShaderMaterial!==!0&&(b=`#version 300 es
`,m=["precision mediump sampler2DArray;","#define attribute in","#define varying out","#define texture2D texture"].join(`
`)+`
`+m,v=["#define varying in",t.glslVersion===vc?"":"layout(location = 0) out highp vec4 pc_fragColor;",t.glslVersion===vc?"":"#define gl_FragColor pc_fragColor","#define gl_FragDepthEXT gl_FragDepth","#define texture2D texture","#define textureCube texture","#define texture2DProj textureProj","#define texture2DLodEXT textureLod","#define texture2DProjLodEXT textureProjLod","#define textureCubeLodEXT textureLod","#define texture2DGradEXT textureGrad","#define texture2DProjGradEXT textureProjGrad","#define textureCubeGradEXT textureGrad"].join(`
`)+`
`+v);const _=b+m+a,S=b+v+o,E=jc(r,35633,_),L=jc(r,35632,S);if(r.attachShader(p,E),r.attachShader(p,L),t.index0AttributeName!==void 0?r.bindAttribLocation(p,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(p,0,"position"),r.linkProgram(p),n.debug.checkShaderErrors){const P=r.getProgramInfoLog(p).trim(),U=r.getShaderInfoLog(E).trim(),J=r.getShaderInfoLog(L).trim();let ce=!0,V=!0;if(r.getProgramParameter(p,35714)===!1){ce=!1;const z=Xc(r,E,"vertex"),Z=Xc(r,L,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(p,35715)+`

Program Info Log: `+P+`
`+z+`
`+Z)}else P!==""?console.warn("THREE.WebGLProgram: Program Info Log:",P):(U===""||J==="")&&(V=!1);V&&(this.diagnostics={runnable:ce,programLog:P,vertexShader:{log:U,prefix:m},fragmentShader:{log:J,prefix:v}})}r.deleteShader(E),r.deleteShader(L);let O;this.getUniforms=function(){return O===void 0&&(O=new As(r,p)),O};let M;return this.getAttributes=function(){return M===void 0&&(M=cy(r,p)),M},this.destroy=function(){i.releaseStatesOfProgram(this),r.deleteProgram(p),this.program=void 0},this.name=t.shaderName,this.id=ny++,this.cacheKey=e,this.usedTimes=1,this.program=p,this.vertexShader=E,this.fragmentShader=L,this}let yy=0;class by{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e){const t=e.vertexShader,i=e.fragmentShader,r=this._getShaderStage(t),s=this._getShaderStage(i),a=this._getShaderCacheForMaterial(e);return a.has(r)===!1&&(a.add(r),r.usedTimes++),a.has(s)===!1&&(a.add(s),s.usedTimes++),this}remove(e){const t=this.materialCache.get(e);for(const i of t)i.usedTimes--,i.usedTimes===0&&this.shaderCache.delete(i.code);return this.materialCache.delete(e),this}getVertexShaderID(e){return this._getShaderStage(e.vertexShader).id}getFragmentShaderID(e){return this._getShaderStage(e.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){const t=this.materialCache;let i=t.get(e);return i===void 0&&(i=new Set,t.set(e,i)),i}_getShaderStage(e){const t=this.shaderCache;let i=t.get(e);return i===void 0&&(i=new My(e),t.set(e,i)),i}}class My{constructor(e){this.id=yy++,this.code=e,this.usedTimes=0}}function Sy(n,e,t,i,r,s,a){const o=new Ha,l=new by,c=[],u=r.isWebGL2,f=r.logarithmicDepthBuffer,h=r.vertexTextures;let d=r.precision;const g={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distanceRGBA",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function p(M,P,U,J,ce){const V=J.fog,z=ce.geometry,Z=M.isMeshStandardMaterial?J.environment:null,re=(M.isMeshStandardMaterial?t:e).get(M.envMap||Z),se=re&&re.mapping===qs?re.image.height:null,W=g[M.type];M.precision!==null&&(d=r.getMaxPrecision(M.precision),d!==M.precision&&console.warn("THREE.WebGLProgram.getParameters:",M.precision,"not supported, using",d,"instead."));const ae=z.morphAttributes.position||z.morphAttributes.normal||z.morphAttributes.color,he=ae!==void 0?ae.length:0;let we=0;z.morphAttributes.position!==void 0&&(we=1),z.morphAttributes.normal!==void 0&&(we=2),z.morphAttributes.color!==void 0&&(we=3);let j,fe,_e,k;if(W){const Se=gn[W];j=Se.vertexShader,fe=Se.fragmentShader}else j=M.vertexShader,fe=M.fragmentShader,l.update(M),_e=l.getVertexShaderID(M),k=l.getFragmentShaderID(M);const be=n.getRenderTarget(),I=M.alphaTest>0,K=M.clearcoat>0,q=M.iridescence>0;return{isWebGL2:u,shaderID:W,shaderName:M.type,vertexShader:j,fragmentShader:fe,defines:M.defines,customVertexShaderID:_e,customFragmentShaderID:k,isRawShaderMaterial:M.isRawShaderMaterial===!0,glslVersion:M.glslVersion,precision:d,instancing:ce.isInstancedMesh===!0,instancingColor:ce.isInstancedMesh===!0&&ce.instanceColor!==null,supportsVertexTextures:h,outputEncoding:be===null?n.outputEncoding:be.isXRRenderTarget===!0?be.texture.encoding:yi,map:!!M.map,matcap:!!M.matcap,envMap:!!re,envMapMode:re&&re.mapping,envMapCubeUVHeight:se,lightMap:!!M.lightMap,aoMap:!!M.aoMap,emissiveMap:!!M.emissiveMap,bumpMap:!!M.bumpMap,normalMap:!!M.normalMap,objectSpaceNormalMap:M.normalMapType===Bg,tangentSpaceNormalMap:M.normalMapType===zg,decodeVideoTexture:!!M.map&&M.map.isVideoTexture===!0&&M.map.encoding===Qe,clearcoat:K,clearcoatMap:K&&!!M.clearcoatMap,clearcoatRoughnessMap:K&&!!M.clearcoatRoughnessMap,clearcoatNormalMap:K&&!!M.clearcoatNormalMap,iridescence:q,iridescenceMap:q&&!!M.iridescenceMap,iridescenceThicknessMap:q&&!!M.iridescenceThicknessMap,displacementMap:!!M.displacementMap,roughnessMap:!!M.roughnessMap,metalnessMap:!!M.metalnessMap,specularMap:!!M.specularMap,specularIntensityMap:!!M.specularIntensityMap,specularColorMap:!!M.specularColorMap,opaque:M.transparent===!1&&M.blending===Ki,alphaMap:!!M.alphaMap,alphaTest:I,gradientMap:!!M.gradientMap,sheen:M.sheen>0,sheenColorMap:!!M.sheenColorMap,sheenRoughnessMap:!!M.sheenRoughnessMap,transmission:M.transmission>0,transmissionMap:!!M.transmissionMap,thicknessMap:!!M.thicknessMap,combine:M.combine,vertexTangents:!!M.normalMap&&!!z.attributes.tangent,vertexColors:M.vertexColors,vertexAlphas:M.vertexColors===!0&&!!z.attributes.color&&z.attributes.color.itemSize===4,vertexUvs:!!M.map||!!M.bumpMap||!!M.normalMap||!!M.specularMap||!!M.alphaMap||!!M.emissiveMap||!!M.roughnessMap||!!M.metalnessMap||!!M.clearcoatMap||!!M.clearcoatRoughnessMap||!!M.clearcoatNormalMap||!!M.iridescenceMap||!!M.iridescenceThicknessMap||!!M.displacementMap||!!M.transmissionMap||!!M.thicknessMap||!!M.specularIntensityMap||!!M.specularColorMap||!!M.sheenColorMap||!!M.sheenRoughnessMap,uvsVertexOnly:!(M.map||M.bumpMap||M.normalMap||M.specularMap||M.alphaMap||M.emissiveMap||M.roughnessMap||M.metalnessMap||M.clearcoatNormalMap||M.iridescenceMap||M.iridescenceThicknessMap||M.transmission>0||M.transmissionMap||M.thicknessMap||M.specularIntensityMap||M.specularColorMap||M.sheen>0||M.sheenColorMap||M.sheenRoughnessMap)&&!!M.displacementMap,fog:!!V,useFog:M.fog===!0,fogExp2:V&&V.isFogExp2,flatShading:!!M.flatShading,sizeAttenuation:M.sizeAttenuation,logarithmicDepthBuffer:f,skinning:ce.isSkinnedMesh===!0,morphTargets:z.morphAttributes.position!==void 0,morphNormals:z.morphAttributes.normal!==void 0,morphColors:z.morphAttributes.color!==void 0,morphTargetsCount:he,morphTextureStride:we,numDirLights:P.directional.length,numPointLights:P.point.length,numSpotLights:P.spot.length,numSpotLightMaps:P.spotLightMap.length,numRectAreaLights:P.rectArea.length,numHemiLights:P.hemi.length,numDirLightShadows:P.directionalShadowMap.length,numPointLightShadows:P.pointShadowMap.length,numSpotLightShadows:P.spotShadowMap.length,numSpotLightShadowsWithMaps:P.numSpotLightShadowsWithMaps,numClippingPlanes:a.numPlanes,numClipIntersection:a.numIntersection,dithering:M.dithering,shadowMapEnabled:n.shadowMap.enabled&&U.length>0,shadowMapType:n.shadowMap.type,toneMapping:M.toneMapped?n.toneMapping:In,useLegacyLights:n.useLegacyLights,premultipliedAlpha:M.premultipliedAlpha,doubleSided:M.side===Wn,flipSided:M.side===Ft,useDepthPacking:!!M.depthPacking,depthPacking:M.depthPacking||0,index0AttributeName:M.index0AttributeName,extensionDerivatives:M.extensions&&M.extensions.derivatives,extensionFragDepth:M.extensions&&M.extensions.fragDepth,extensionDrawBuffers:M.extensions&&M.extensions.drawBuffers,extensionShaderTextureLOD:M.extensions&&M.extensions.shaderTextureLOD,rendererExtensionFragDepth:u||i.has("EXT_frag_depth"),rendererExtensionDrawBuffers:u||i.has("WEBGL_draw_buffers"),rendererExtensionShaderTextureLod:u||i.has("EXT_shader_texture_lod"),customProgramCacheKey:M.customProgramCacheKey()}}function m(M){const P=[];if(M.shaderID?P.push(M.shaderID):(P.push(M.customVertexShaderID),P.push(M.customFragmentShaderID)),M.defines!==void 0)for(const U in M.defines)P.push(U),P.push(M.defines[U]);return M.isRawShaderMaterial===!1&&(v(P,M),b(P,M),P.push(n.outputEncoding)),P.push(M.customProgramCacheKey),P.join()}function v(M,P){M.push(P.precision),M.push(P.outputEncoding),M.push(P.envMapMode),M.push(P.envMapCubeUVHeight),M.push(P.combine),M.push(P.vertexUvs),M.push(P.fogExp2),M.push(P.sizeAttenuation),M.push(P.morphTargetsCount),M.push(P.morphAttributeCount),M.push(P.numDirLights),M.push(P.numPointLights),M.push(P.numSpotLights),M.push(P.numSpotLightMaps),M.push(P.numHemiLights),M.push(P.numRectAreaLights),M.push(P.numDirLightShadows),M.push(P.numPointLightShadows),M.push(P.numSpotLightShadows),M.push(P.numSpotLightShadowsWithMaps),M.push(P.shadowMapType),M.push(P.toneMapping),M.push(P.numClippingPlanes),M.push(P.numClipIntersection),M.push(P.depthPacking)}function b(M,P){o.disableAll(),P.isWebGL2&&o.enable(0),P.supportsVertexTextures&&o.enable(1),P.instancing&&o.enable(2),P.instancingColor&&o.enable(3),P.map&&o.enable(4),P.matcap&&o.enable(5),P.envMap&&o.enable(6),P.lightMap&&o.enable(7),P.aoMap&&o.enable(8),P.emissiveMap&&o.enable(9),P.bumpMap&&o.enable(10),P.normalMap&&o.enable(11),P.objectSpaceNormalMap&&o.enable(12),P.tangentSpaceNormalMap&&o.enable(13),P.clearcoat&&o.enable(14),P.clearcoatMap&&o.enable(15),P.clearcoatRoughnessMap&&o.enable(16),P.clearcoatNormalMap&&o.enable(17),P.iridescence&&o.enable(18),P.iridescenceMap&&o.enable(19),P.iridescenceThicknessMap&&o.enable(20),P.displacementMap&&o.enable(21),P.specularMap&&o.enable(22),P.roughnessMap&&o.enable(23),P.metalnessMap&&o.enable(24),P.gradientMap&&o.enable(25),P.alphaMap&&o.enable(26),P.alphaTest&&o.enable(27),P.vertexColors&&o.enable(28),P.vertexAlphas&&o.enable(29),P.vertexUvs&&o.enable(30),P.vertexTangents&&o.enable(31),P.uvsVertexOnly&&o.enable(32),M.push(o.mask),o.disableAll(),P.fog&&o.enable(0),P.useFog&&o.enable(1),P.flatShading&&o.enable(2),P.logarithmicDepthBuffer&&o.enable(3),P.skinning&&o.enable(4),P.morphTargets&&o.enable(5),P.morphNormals&&o.enable(6),P.morphColors&&o.enable(7),P.premultipliedAlpha&&o.enable(8),P.shadowMapEnabled&&o.enable(9),P.useLegacyLights&&o.enable(10),P.doubleSided&&o.enable(11),P.flipSided&&o.enable(12),P.useDepthPacking&&o.enable(13),P.dithering&&o.enable(14),P.specularIntensityMap&&o.enable(15),P.specularColorMap&&o.enable(16),P.transmission&&o.enable(17),P.transmissionMap&&o.enable(18),P.thicknessMap&&o.enable(19),P.sheen&&o.enable(20),P.sheenColorMap&&o.enable(21),P.sheenRoughnessMap&&o.enable(22),P.decodeVideoTexture&&o.enable(23),P.opaque&&o.enable(24),M.push(o.mask)}function _(M){const P=g[M.type];let U;if(P){const J=gn[P];U=l_.clone(J.uniforms)}else U=M.uniforms;return U}function S(M,P){let U;for(let J=0,ce=c.length;J<ce;J++){const V=c[J];if(V.cacheKey===P){U=V,++U.usedTimes;break}}return U===void 0&&(U=new xy(n,P,M,s),c.push(U)),U}function E(M){if(--M.usedTimes===0){const P=c.indexOf(M);c[P]=c[c.length-1],c.pop(),M.destroy()}}function L(M){l.remove(M)}function O(){l.dispose()}return{getParameters:p,getProgramCacheKey:m,getUniforms:_,acquireProgram:S,releaseProgram:E,releaseShaderCache:L,programs:c,dispose:O}}function wy(){let n=new WeakMap;function e(s){let a=n.get(s);return a===void 0&&(a={},n.set(s,a)),a}function t(s){n.delete(s)}function i(s,a,o){n.get(s)[a]=o}function r(){n=new WeakMap}return{get:e,remove:t,update:i,dispose:r}}function Ey(n,e){return n.groupOrder!==e.groupOrder?n.groupOrder-e.groupOrder:n.renderOrder!==e.renderOrder?n.renderOrder-e.renderOrder:n.material.id!==e.material.id?n.material.id-e.material.id:n.z!==e.z?n.z-e.z:n.id-e.id}function Kc(n,e){return n.groupOrder!==e.groupOrder?n.groupOrder-e.groupOrder:n.renderOrder!==e.renderOrder?n.renderOrder-e.renderOrder:n.z!==e.z?e.z-n.z:n.id-e.id}function Jc(){const n=[];let e=0;const t=[],i=[],r=[];function s(){e=0,t.length=0,i.length=0,r.length=0}function a(f,h,d,g,p,m){let v=n[e];return v===void 0?(v={id:f.id,object:f,geometry:h,material:d,groupOrder:g,renderOrder:f.renderOrder,z:p,group:m},n[e]=v):(v.id=f.id,v.object=f,v.geometry=h,v.material=d,v.groupOrder=g,v.renderOrder=f.renderOrder,v.z=p,v.group=m),e++,v}function o(f,h,d,g,p,m){const v=a(f,h,d,g,p,m);d.transmission>0?i.push(v):d.transparent===!0?r.push(v):t.push(v)}function l(f,h,d,g,p,m){const v=a(f,h,d,g,p,m);d.transmission>0?i.unshift(v):d.transparent===!0?r.unshift(v):t.unshift(v)}function c(f,h){t.length>1&&t.sort(f||Ey),i.length>1&&i.sort(h||Kc),r.length>1&&r.sort(h||Kc)}function u(){for(let f=e,h=n.length;f<h;f++){const d=n[f];if(d.id===null)break;d.id=null,d.object=null,d.geometry=null,d.material=null,d.group=null}}return{opaque:t,transmissive:i,transparent:r,init:s,push:o,unshift:l,finish:u,sort:c}}function Ty(){let n=new WeakMap;function e(i,r){const s=n.get(i);let a;return s===void 0?(a=new Jc,n.set(i,[a])):r>=s.length?(a=new Jc,s.push(a)):a=s[r],a}function t(){n=new WeakMap}return{get:e,dispose:t}}function Ay(){const n={};return{get:function(e){if(n[e.id]!==void 0)return n[e.id];let t;switch(e.type){case"DirectionalLight":t={direction:new N,color:new Xe};break;case"SpotLight":t={position:new N,direction:new N,color:new Xe,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":t={position:new N,color:new Xe,distance:0,decay:0};break;case"HemisphereLight":t={direction:new N,skyColor:new Xe,groundColor:new Xe};break;case"RectAreaLight":t={color:new Xe,position:new N,halfWidth:new N,halfHeight:new N};break}return n[e.id]=t,t}}}function Cy(){const n={};return{get:function(e){if(n[e.id]!==void 0)return n[e.id];let t;switch(e.type){case"DirectionalLight":t={shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Ge};break;case"SpotLight":t={shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Ge};break;case"PointLight":t={shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Ge,shadowCameraNear:1,shadowCameraFar:1e3};break}return n[e.id]=t,t}}}let Py=0;function Ly(n,e){return(e.castShadow?2:0)-(n.castShadow?2:0)+(e.map?1:0)-(n.map?1:0)}function Ry(n,e){const t=new Ay,i=Cy(),r={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0};for(let u=0;u<9;u++)r.probe.push(new N);const s=new N,a=new lt,o=new lt;function l(u,f){let h=0,d=0,g=0;for(let J=0;J<9;J++)r.probe[J].set(0,0,0);let p=0,m=0,v=0,b=0,_=0,S=0,E=0,L=0,O=0,M=0;u.sort(Ly);const P=f===!0?Math.PI:1;for(let J=0,ce=u.length;J<ce;J++){const V=u[J],z=V.color,Z=V.intensity,re=V.distance,se=V.shadow&&V.shadow.map?V.shadow.map.texture:null;if(V.isAmbientLight)h+=z.r*Z*P,d+=z.g*Z*P,g+=z.b*Z*P;else if(V.isLightProbe)for(let W=0;W<9;W++)r.probe[W].addScaledVector(V.sh.coefficients[W],Z);else if(V.isDirectionalLight){const W=t.get(V);if(W.color.copy(V.color).multiplyScalar(V.intensity*P),V.castShadow){const ae=V.shadow,he=i.get(V);he.shadowBias=ae.bias,he.shadowNormalBias=ae.normalBias,he.shadowRadius=ae.radius,he.shadowMapSize=ae.mapSize,r.directionalShadow[p]=he,r.directionalShadowMap[p]=se,r.directionalShadowMatrix[p]=V.shadow.matrix,S++}r.directional[p]=W,p++}else if(V.isSpotLight){const W=t.get(V);W.position.setFromMatrixPosition(V.matrixWorld),W.color.copy(z).multiplyScalar(Z*P),W.distance=re,W.coneCos=Math.cos(V.angle),W.penumbraCos=Math.cos(V.angle*(1-V.penumbra)),W.decay=V.decay,r.spot[v]=W;const ae=V.shadow;if(V.map&&(r.spotLightMap[O]=V.map,O++,ae.updateMatrices(V),V.castShadow&&M++),r.spotLightMatrix[v]=ae.matrix,V.castShadow){const he=i.get(V);he.shadowBias=ae.bias,he.shadowNormalBias=ae.normalBias,he.shadowRadius=ae.radius,he.shadowMapSize=ae.mapSize,r.spotShadow[v]=he,r.spotShadowMap[v]=se,L++}v++}else if(V.isRectAreaLight){const W=t.get(V);W.color.copy(z).multiplyScalar(Z),W.halfWidth.set(V.width*.5,0,0),W.halfHeight.set(0,V.height*.5,0),r.rectArea[b]=W,b++}else if(V.isPointLight){const W=t.get(V);if(W.color.copy(V.color).multiplyScalar(V.intensity*P),W.distance=V.distance,W.decay=V.decay,V.castShadow){const ae=V.shadow,he=i.get(V);he.shadowBias=ae.bias,he.shadowNormalBias=ae.normalBias,he.shadowRadius=ae.radius,he.shadowMapSize=ae.mapSize,he.shadowCameraNear=ae.camera.near,he.shadowCameraFar=ae.camera.far,r.pointShadow[m]=he,r.pointShadowMap[m]=se,r.pointShadowMatrix[m]=V.shadow.matrix,E++}r.point[m]=W,m++}else if(V.isHemisphereLight){const W=t.get(V);W.skyColor.copy(V.color).multiplyScalar(Z*P),W.groundColor.copy(V.groundColor).multiplyScalar(Z*P),r.hemi[_]=W,_++}}b>0&&(e.isWebGL2||n.has("OES_texture_float_linear")===!0?(r.rectAreaLTC1=ye.LTC_FLOAT_1,r.rectAreaLTC2=ye.LTC_FLOAT_2):n.has("OES_texture_half_float_linear")===!0?(r.rectAreaLTC1=ye.LTC_HALF_1,r.rectAreaLTC2=ye.LTC_HALF_2):console.error("THREE.WebGLRenderer: Unable to use RectAreaLight. Missing WebGL extensions.")),r.ambient[0]=h,r.ambient[1]=d,r.ambient[2]=g;const U=r.hash;(U.directionalLength!==p||U.pointLength!==m||U.spotLength!==v||U.rectAreaLength!==b||U.hemiLength!==_||U.numDirectionalShadows!==S||U.numPointShadows!==E||U.numSpotShadows!==L||U.numSpotMaps!==O)&&(r.directional.length=p,r.spot.length=v,r.rectArea.length=b,r.point.length=m,r.hemi.length=_,r.directionalShadow.length=S,r.directionalShadowMap.length=S,r.pointShadow.length=E,r.pointShadowMap.length=E,r.spotShadow.length=L,r.spotShadowMap.length=L,r.directionalShadowMatrix.length=S,r.pointShadowMatrix.length=E,r.spotLightMatrix.length=L+O-M,r.spotLightMap.length=O,r.numSpotLightShadowsWithMaps=M,U.directionalLength=p,U.pointLength=m,U.spotLength=v,U.rectAreaLength=b,U.hemiLength=_,U.numDirectionalShadows=S,U.numPointShadows=E,U.numSpotShadows=L,U.numSpotMaps=O,r.version=Py++)}function c(u,f){let h=0,d=0,g=0,p=0,m=0;const v=f.matrixWorldInverse;for(let b=0,_=u.length;b<_;b++){const S=u[b];if(S.isDirectionalLight){const E=r.directional[h];E.direction.setFromMatrixPosition(S.matrixWorld),s.setFromMatrixPosition(S.target.matrixWorld),E.direction.sub(s),E.direction.transformDirection(v),h++}else if(S.isSpotLight){const E=r.spot[g];E.position.setFromMatrixPosition(S.matrixWorld),E.position.applyMatrix4(v),E.direction.setFromMatrixPosition(S.matrixWorld),s.setFromMatrixPosition(S.target.matrixWorld),E.direction.sub(s),E.direction.transformDirection(v),g++}else if(S.isRectAreaLight){const E=r.rectArea[p];E.position.setFromMatrixPosition(S.matrixWorld),E.position.applyMatrix4(v),o.identity(),a.copy(S.matrixWorld),a.premultiply(v),o.extractRotation(a),E.halfWidth.set(S.width*.5,0,0),E.halfHeight.set(0,S.height*.5,0),E.halfWidth.applyMatrix4(o),E.halfHeight.applyMatrix4(o),p++}else if(S.isPointLight){const E=r.point[d];E.position.setFromMatrixPosition(S.matrixWorld),E.position.applyMatrix4(v),d++}else if(S.isHemisphereLight){const E=r.hemi[m];E.direction.setFromMatrixPosition(S.matrixWorld),E.direction.transformDirection(v),m++}}}return{setup:l,setupView:c,state:r}}function Qc(n,e){const t=new Ry(n,e),i=[],r=[];function s(){i.length=0,r.length=0}function a(f){i.push(f)}function o(f){r.push(f)}function l(f){t.setup(i,f)}function c(f){t.setupView(i,f)}return{init:s,state:{lightsArray:i,shadowsArray:r,lights:t},setupLights:l,setupLightsView:c,pushLight:a,pushShadow:o}}function Dy(n,e){let t=new WeakMap;function i(s,a=0){const o=t.get(s);let l;return o===void 0?(l=new Qc(n,e),t.set(s,[l])):a>=o.length?(l=new Qc(n,e),o.push(l)):l=o[a],l}function r(){t=new WeakMap}return{get:i,dispose:r}}class Iy extends Zr{constructor(e){super(),this.isMeshDepthMaterial=!0,this.type="MeshDepthMaterial",this.depthPacking=Ng,this.map=null,this.alphaMap=null,this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.wireframe=!1,this.wireframeLinewidth=1,this.setValues(e)}copy(e){return super.copy(e),this.depthPacking=e.depthPacking,this.map=e.map,this.alphaMap=e.alphaMap,this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this.wireframe=e.wireframe,this.wireframeLinewidth=e.wireframeLinewidth,this}}class Oy extends Zr{constructor(e){super(),this.isMeshDistanceMaterial=!0,this.type="MeshDistanceMaterial",this.referencePosition=new N,this.nearDistance=1,this.farDistance=1e3,this.map=null,this.alphaMap=null,this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.setValues(e)}copy(e){return super.copy(e),this.referencePosition.copy(e.referencePosition),this.nearDistance=e.nearDistance,this.farDistance=e.farDistance,this.map=e.map,this.alphaMap=e.alphaMap,this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this}}const Fy=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`;function Uy(n,e,t){let i=new Qf;const r=new Ge,s=new Ge,a=new _t,o=new Iy({depthPacking:Ug}),l=new Oy,c={},u=t.maxTextureSize,f={[Zn]:Ft,[Ft]:Zn,[Wn]:Wn},h=new $n({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Ge},radius:{value:4}},vertexShader:Fy,fragmentShader:Ny}),d=h.clone();d.defines.HORIZONTAL_PASS=1;const g=new ln;g.setAttribute("position",new yn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const p=new vn(g,h),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Nf,this.render=function(S,E,L){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||S.length===0)return;const O=n.getRenderTarget(),M=n.getActiveCubeFace(),P=n.getActiveMipmapLevel(),U=n.state;U.setBlending(qn),U.buffers.color.setClear(1,1,1,1),U.buffers.depth.setTest(!0),U.setScissorTest(!1);for(let J=0,ce=S.length;J<ce;J++){const V=S[J],z=V.shadow;if(z===void 0){console.warn("THREE.WebGLShadowMap:",V,"has no shadow.");continue}if(z.autoUpdate===!1&&z.needsUpdate===!1)continue;r.copy(z.mapSize);const Z=z.getFrameExtents();if(r.multiply(Z),s.copy(z.mapSize),(r.x>u||r.y>u)&&(r.x>u&&(s.x=Math.floor(u/Z.x),r.x=s.x*Z.x,z.mapSize.x=s.x),r.y>u&&(s.y=Math.floor(u/Z.y),r.y=s.y*Z.y,z.mapSize.y=s.y)),z.map===null){const se=this.type!==Mr?{minFilter:Pt,magFilter:Pt}:{};z.map=new Mi(r.x,r.y,se),z.map.texture.name=V.name+".shadowMap",z.camera.updateProjectionMatrix()}n.setRenderTarget(z.map),n.clear();const re=z.getViewportCount();for(let se=0;se<re;se++){const W=z.getViewport(se);a.set(s.x*W.x,s.y*W.y,s.x*W.z,s.y*W.w),U.viewport(a),z.updateMatrices(V,se),i=z.getFrustum(),_(E,L,z.camera,V,this.type)}z.isPointLightShadow!==!0&&this.type===Mr&&v(z,L),z.needsUpdate=!1}m.needsUpdate=!1,n.setRenderTarget(O,M,P)};function v(S,E){const L=e.update(p);h.defines.VSM_SAMPLES!==S.blurSamples&&(h.defines.VSM_SAMPLES=S.blurSamples,d.defines.VSM_SAMPLES=S.blurSamples,h.needsUpdate=!0,d.needsUpdate=!0),S.mapPass===null&&(S.mapPass=new Mi(r.x,r.y)),h.uniforms.shadow_pass.value=S.map.texture,h.uniforms.resolution.value=S.mapSize,h.uniforms.radius.value=S.radius,n.setRenderTarget(S.mapPass),n.clear(),n.renderBufferDirect(E,null,L,h,p,null),d.uniforms.shadow_pass.value=S.mapPass.texture,d.uniforms.resolution.value=S.mapSize,d.uniforms.radius.value=S.radius,n.setRenderTarget(S.map),n.clear(),n.renderBufferDirect(E,null,L,d,p,null)}function b(S,E,L,O,M,P){let U=null;const J=L.isPointLight===!0?S.customDistanceMaterial:S.customDepthMaterial;if(J!==void 0)U=J;else if(U=L.isPointLight===!0?l:o,n.localClippingEnabled&&E.clipShadows===!0&&Array.isArray(E.clippingPlanes)&&E.clippingPlanes.length!==0||E.displacementMap&&E.displacementScale!==0||E.alphaMap&&E.alphaTest>0||E.map&&E.alphaTest>0){const ce=U.uuid,V=E.uuid;let z=c[ce];z===void 0&&(z={},c[ce]=z);let Z=z[V];Z===void 0&&(Z=U.clone(),z[V]=Z),U=Z}return U.visible=E.visible,U.wireframe=E.wireframe,P===Mr?U.side=E.shadowSide!==null?E.shadowSide:E.side:U.side=E.shadowSide!==null?E.shadowSide:f[E.side],U.alphaMap=E.alphaMap,U.alphaTest=E.alphaTest,U.map=E.map,U.clipShadows=E.clipShadows,U.clippingPlanes=E.clippingPlanes,U.clipIntersection=E.clipIntersection,U.displacementMap=E.displacementMap,U.displacementScale=E.displacementScale,U.displacementBias=E.displacementBias,U.wireframeLinewidth=E.wireframeLinewidth,U.linewidth=E.linewidth,L.isPointLight===!0&&U.isMeshDistanceMaterial===!0&&(U.referencePosition.setFromMatrixPosition(L.matrixWorld),U.nearDistance=O,U.farDistance=M),U}function _(S,E,L,O,M){if(S.visible===!1)return;if(S.layers.test(E.layers)&&(S.isMesh||S.isLine||S.isPoints)&&(S.castShadow||S.receiveShadow&&M===Mr)&&(!S.frustumCulled||i.intersectsObject(S))){S.modelViewMatrix.multiplyMatrices(L.matrixWorldInverse,S.matrixWorld);const J=e.update(S),ce=S.material;if(Array.isArray(ce)){const V=J.groups;for(let z=0,Z=V.length;z<Z;z++){const re=V[z],se=ce[re.materialIndex];if(se&&se.visible){const W=b(S,se,O,L.near,L.far,M);n.renderBufferDirect(L,null,J,W,S,re)}}}else if(ce.visible){const V=b(S,ce,O,L.near,L.far,M);n.renderBufferDirect(L,null,J,V,S,null)}}const U=S.children;for(let J=0,ce=U.length;J<ce;J++)_(U[J],E,L,O,M)}}function zy(n,e,t){const i=t.isWebGL2;function r(){let D=!1;const te=new _t;let me=null;const Ee=new _t(0,0,0,0);return{setMask:function(Pe){me!==Pe&&!D&&(n.colorMask(Pe,Pe,Pe,Pe),me=Pe)},setLocked:function(Pe){D=Pe},setClear:function(Pe,Je,ht,wt,cn){cn===!0&&(Pe*=wt,Je*=wt,ht*=wt),te.set(Pe,Je,ht,wt),Ee.equals(te)===!1&&(n.clearColor(Pe,Je,ht,wt),Ee.copy(te))},reset:function(){D=!1,me=null,Ee.set(-1,0,0,0)}}}function s(){let D=!1,te=null,me=null,Ee=null;return{setTest:function(Pe){Pe?I(2929):K(2929)},setMask:function(Pe){te!==Pe&&!D&&(n.depthMask(Pe),te=Pe)},setFunc:function(Pe){if(me!==Pe){switch(Pe){case og:n.depthFunc(512);break;case ag:n.depthFunc(519);break;case lg:n.depthFunc(513);break;case da:n.depthFunc(515);break;case cg:n.depthFunc(514);break;case ug:n.depthFunc(518);break;case fg:n.depthFunc(516);break;case hg:n.depthFunc(517);break;default:n.depthFunc(515)}me=Pe}},setLocked:function(Pe){D=Pe},setClear:function(Pe){Ee!==Pe&&(n.clearDepth(Pe),Ee=Pe)},reset:function(){D=!1,te=null,me=null,Ee=null}}}function a(){let D=!1,te=null,me=null,Ee=null,Pe=null,Je=null,ht=null,wt=null,cn=null;return{setTest:function(nt){D||(nt?I(2960):K(2960))},setMask:function(nt){te!==nt&&!D&&(n.stencilMask(nt),te=nt)},setFunc:function(nt,Xt,un){(me!==nt||Ee!==Xt||Pe!==un)&&(n.stencilFunc(nt,Xt,un),me=nt,Ee=Xt,Pe=un)},setOp:function(nt,Xt,un){(Je!==nt||ht!==Xt||wt!==un)&&(n.stencilOp(nt,Xt,un),Je=nt,ht=Xt,wt=un)},setLocked:function(nt){D=nt},setClear:function(nt){cn!==nt&&(n.clearStencil(nt),cn=nt)},reset:function(){D=!1,te=null,me=null,Ee=null,Pe=null,Je=null,ht=null,wt=null,cn=null}}}const o=new r,l=new s,c=new a,u=new WeakMap,f=new WeakMap;let h={},d={},g=new WeakMap,p=[],m=null,v=!1,b=null,_=null,S=null,E=null,L=null,O=null,M=null,P=!1,U=null,J=null,ce=null,V=null,z=null;const Z=n.getParameter(35661);let re=!1,se=0;const W=n.getParameter(7938);W.indexOf("WebGL")!==-1?(se=parseFloat(/^WebGL (\d)/.exec(W)[1]),re=se>=1):W.indexOf("OpenGL ES")!==-1&&(se=parseFloat(/^OpenGL ES (\d)/.exec(W)[1]),re=se>=2);let ae=null,he={};const we=n.getParameter(3088),j=n.getParameter(2978),fe=new _t().fromArray(we),_e=new _t().fromArray(j);function k(D,te,me){const Ee=new Uint8Array(4),Pe=n.createTexture();n.bindTexture(D,Pe),n.texParameteri(D,10241,9728),n.texParameteri(D,10240,9728);for(let Je=0;Je<me;Je++)n.texImage2D(te+Je,0,6408,1,1,0,6408,5121,Ee);return Pe}const be={};be[3553]=k(3553,3553,1),be[34067]=k(34067,34069,6),o.setClear(0,0,0,1),l.setClear(1),c.setClear(0),I(2929),l.setFunc(da),ne(!1),Y(Vl),I(2884),C(qn);function I(D){h[D]!==!0&&(n.enable(D),h[D]=!0)}function K(D){h[D]!==!1&&(n.disable(D),h[D]=!1)}function q(D,te){return d[D]!==te?(n.bindFramebuffer(D,te),d[D]=te,i&&(D===36009&&(d[36160]=te),D===36160&&(d[36009]=te)),!0):!1}function oe(D,te){let me=p,Ee=!1;if(D)if(me=g.get(te),me===void 0&&(me=[],g.set(te,me)),D.isWebGLMultipleRenderTargets){const Pe=D.texture;if(me.length!==Pe.length||me[0]!==36064){for(let Je=0,ht=Pe.length;Je<ht;Je++)me[Je]=36064+Je;me.length=Pe.length,Ee=!0}}else me[0]!==36064&&(me[0]=36064,Ee=!0);else me[0]!==1029&&(me[0]=1029,Ee=!0);Ee&&(t.isWebGL2?n.drawBuffers(me):e.get("WEBGL_draw_buffers").drawBuffersWEBGL(me))}function Se(D){return m!==D?(n.useProgram(D),m=D,!0):!1}const Te={[ji]:32774,[Zm]:32778,[$m]:32779};if(i)Te[jl]=32775,Te[Xl]=32776;else{const D=e.get("EXT_blend_minmax");D!==null&&(Te[jl]=D.MIN_EXT,Te[Xl]=D.MAX_EXT)}const w={[Km]:0,[Jm]:1,[Qm]:768,[Uf]:770,[sg]:776,[ig]:774,[tg]:772,[eg]:769,[zf]:771,[rg]:775,[ng]:773};function C(D,te,me,Ee,Pe,Je,ht,wt){if(D===qn){v===!0&&(K(3042),v=!1);return}if(v===!1&&(I(3042),v=!0),D!==Ym){if(D!==b||wt!==P){if((_!==ji||L!==ji)&&(n.blendEquation(32774),_=ji,L=ji),wt)switch(D){case Ki:n.blendFuncSeparate(1,771,1,771);break;case ha:n.blendFunc(1,1);break;case Hl:n.blendFuncSeparate(0,769,0,1);break;case Wl:n.blendFuncSeparate(0,768,0,770);break;default:console.error("THREE.WebGLState: Invalid blending: ",D);break}else switch(D){case Ki:n.blendFuncSeparate(770,771,1,771);break;case ha:n.blendFunc(770,1);break;case Hl:n.blendFuncSeparate(0,769,0,1);break;case Wl:n.blendFunc(0,768);break;default:console.error("THREE.WebGLState: Invalid blending: ",D);break}S=null,E=null,O=null,M=null,b=D,P=wt}return}Pe=Pe||te,Je=Je||me,ht=ht||Ee,(te!==_||Pe!==L)&&(n.blendEquationSeparate(Te[te],Te[Pe]),_=te,L=Pe),(me!==S||Ee!==E||Je!==O||ht!==M)&&(n.blendFuncSeparate(w[me],w[Ee],w[Je],w[ht]),S=me,E=Ee,O=Je,M=ht),b=D,P=!1}function B(D,te){D.side===Wn?K(2884):I(2884);let me=D.side===Ft;te&&(me=!me),ne(me),D.blending===Ki&&D.transparent===!1?C(qn):C(D.blending,D.blendEquation,D.blendSrc,D.blendDst,D.blendEquationAlpha,D.blendSrcAlpha,D.blendDstAlpha,D.premultipliedAlpha),l.setFunc(D.depthFunc),l.setTest(D.depthTest),l.setMask(D.depthWrite),o.setMask(D.colorWrite);const Ee=D.stencilWrite;c.setTest(Ee),Ee&&(c.setMask(D.stencilWriteMask),c.setFunc(D.stencilFunc,D.stencilRef,D.stencilFuncMask),c.setOp(D.stencilFail,D.stencilZFail,D.stencilZPass)),ue(D.polygonOffset,D.polygonOffsetFactor,D.polygonOffsetUnits),D.alphaToCoverage===!0?I(32926):K(32926)}function ne(D){U!==D&&(D?n.frontFace(2304):n.frontFace(2305),U=D)}function Y(D){D!==jm?(I(2884),D!==J&&(D===Vl?n.cullFace(1029):D===Xm?n.cullFace(1028):n.cullFace(1032))):K(2884),J=D}function ee(D){D!==ce&&(re&&n.lineWidth(D),ce=D)}function ue(D,te,me){D?(I(32823),(V!==te||z!==me)&&(n.polygonOffset(te,me),V=te,z=me)):K(32823)}function pe(D){D?I(3089):K(3089)}function de(D){D===void 0&&(D=33984+Z-1),ae!==D&&(n.activeTexture(D),ae=D)}function y(D,te,me){me===void 0&&(ae===null?me=33984+Z-1:me=ae);let Ee=he[me];Ee===void 0&&(Ee={type:void 0,texture:void 0},he[me]=Ee),(Ee.type!==D||Ee.texture!==te)&&(ae!==me&&(n.activeTexture(me),ae=me),n.bindTexture(D,te||be[D]),Ee.type=D,Ee.texture=te)}function x(){const D=he[ae];D!==void 0&&D.type!==void 0&&(n.bindTexture(D.type,null),D.type=void 0,D.texture=void 0)}function R(){try{n.compressedTexImage2D.apply(n,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function X(){try{n.compressedTexImage3D.apply(n,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function $(){try{n.texSubImage2D.apply(n,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function le(){try{n.texSubImage3D.apply(n,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function xe(){try{n.compressedTexSubImage2D.apply(n,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function A(){try{n.compressedTexSubImage3D.apply(n,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function F(){try{n.texStorage2D.apply(n,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function ve(){try{n.texStorage3D.apply(n,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function ge(){try{n.texImage2D.apply(n,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function Me(){try{n.texImage3D.apply(n,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function Ae(D){fe.equals(D)===!1&&(n.scissor(D.x,D.y,D.z,D.w),fe.copy(D))}function Ce(D){_e.equals(D)===!1&&(n.viewport(D.x,D.y,D.z,D.w),_e.copy(D))}function Re(D,te){let me=f.get(te);me===void 0&&(me=new WeakMap,f.set(te,me));let Ee=me.get(D);Ee===void 0&&(Ee=n.getUniformBlockIndex(te,D.name),me.set(D,Ee))}function De(D,te){const Ee=f.get(te).get(D);u.get(te)!==Ee&&(n.uniformBlockBinding(te,Ee,D.__bindingPointIndex),u.set(te,Ee))}function je(){n.disable(3042),n.disable(2884),n.disable(2929),n.disable(32823),n.disable(3089),n.disable(2960),n.disable(32926),n.blendEquation(32774),n.blendFunc(1,0),n.blendFuncSeparate(1,0,1,0),n.colorMask(!0,!0,!0,!0),n.clearColor(0,0,0,0),n.depthMask(!0),n.depthFunc(513),n.clearDepth(1),n.stencilMask(4294967295),n.stencilFunc(519,0,4294967295),n.stencilOp(7680,7680,7680),n.clearStencil(0),n.cullFace(1029),n.frontFace(2305),n.polygonOffset(0,0),n.activeTexture(33984),n.bindFramebuffer(36160,null),i===!0&&(n.bindFramebuffer(36009,null),n.bindFramebuffer(36008,null)),n.useProgram(null),n.lineWidth(1),n.scissor(0,0,n.canvas.width,n.canvas.height),n.viewport(0,0,n.canvas.width,n.canvas.height),h={},ae=null,he={},d={},g=new WeakMap,p=[],m=null,v=!1,b=null,_=null,S=null,E=null,L=null,O=null,M=null,P=!1,U=null,J=null,ce=null,V=null,z=null,fe.set(0,0,n.canvas.width,n.canvas.height),_e.set(0,0,n.canvas.width,n.canvas.height),o.reset(),l.reset(),c.reset()}return{buffers:{color:o,depth:l,stencil:c},enable:I,disable:K,bindFramebuffer:q,drawBuffers:oe,useProgram:Se,setBlending:C,setMaterial:B,setFlipSided:ne,setCullFace:Y,setLineWidth:ee,setPolygonOffset:ue,setScissorTest:pe,activeTexture:de,bindTexture:y,unbindTexture:x,compressedTexImage2D:R,compressedTexImage3D:X,texImage2D:ge,texImage3D:Me,updateUBOMapping:Re,uniformBlockBinding:De,texStorage2D:F,texStorage3D:ve,texSubImage2D:$,texSubImage3D:le,compressedTexSubImage2D:xe,compressedTexSubImage3D:A,scissor:Ae,viewport:Ce,reset:je}}function By(n,e,t,i,r,s,a){const o=r.isWebGL2,l=r.maxTextures,c=r.maxCubemapSize,u=r.maxTextureSize,f=r.maxSamples,h=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,d=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),g=new WeakMap;let p;const m=new WeakMap;let v=!1;try{v=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function b(y,x){return v?new OffscreenCanvas(y,x):Wr("canvas")}function _(y,x,R,X){let $=1;if((y.width>X||y.height>X)&&($=X/Math.max(y.width,y.height)),$<1||x===!0)if(typeof HTMLImageElement<"u"&&y instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&y instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&y instanceof ImageBitmap){const le=x?Vg:Math.floor,xe=le($*y.width),A=le($*y.height);p===void 0&&(p=b(xe,A));const F=R?b(xe,A):p;return F.width=xe,F.height=A,F.getContext("2d").drawImage(y,0,0,xe,A),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+y.width+"x"+y.height+") to ("+xe+"x"+A+")."),F}else return"data"in y&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+y.width+"x"+y.height+")."),y;return y}function S(y){return yc(y.width)&&yc(y.height)}function E(y){return o?!1:y.wrapS!==nn||y.wrapT!==nn||y.minFilter!==Pt&&y.minFilter!==Zt}function L(y,x){return y.generateMipmaps&&x&&y.minFilter!==Pt&&y.minFilter!==Zt}function O(y){n.generateMipmap(y)}function M(y,x,R,X,$=!1){if(o===!1)return x;if(y!==null){if(n[y]!==void 0)return n[y];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+y+"'")}let le=x;return x===6403&&(R===5126&&(le=33326),R===5131&&(le=33325),R===5121&&(le=33321)),x===33319&&(R===5126&&(le=33328),R===5131&&(le=33327),R===5121&&(le=33323)),x===6408&&(R===5126&&(le=34836),R===5131&&(le=34842),R===5121&&(le=X===Qe&&$===!1?35907:32856),R===32819&&(le=32854),R===32820&&(le=32855)),(le===33325||le===33326||le===33327||le===33328||le===34842||le===34836)&&e.get("EXT_color_buffer_float"),le}function P(y,x,R){return L(y,R)===!0||y.isFramebufferTexture&&y.minFilter!==Pt&&y.minFilter!==Zt?Math.log2(Math.max(x.width,x.height))+1:y.mipmaps!==void 0&&y.mipmaps.length>0?y.mipmaps.length:y.isCompressedTexture&&Array.isArray(y.image)?x.mipmaps.length:1}function U(y){return y===Pt||y===ql||y===_o?9728:9729}function J(y){const x=y.target;x.removeEventListener("dispose",J),V(x),x.isVideoTexture&&g.delete(x)}function ce(y){const x=y.target;x.removeEventListener("dispose",ce),Z(x)}function V(y){const x=i.get(y);if(x.__webglInit===void 0)return;const R=y.source,X=m.get(R);if(X){const $=X[x.__cacheKey];$.usedTimes--,$.usedTimes===0&&z(y),Object.keys(X).length===0&&m.delete(R)}i.remove(y)}function z(y){const x=i.get(y);n.deleteTexture(x.__webglTexture);const R=y.source,X=m.get(R);delete X[x.__cacheKey],a.memory.textures--}function Z(y){const x=y.texture,R=i.get(y),X=i.get(x);if(X.__webglTexture!==void 0&&(n.deleteTexture(X.__webglTexture),a.memory.textures--),y.depthTexture&&y.depthTexture.dispose(),y.isWebGLCubeRenderTarget)for(let $=0;$<6;$++)n.deleteFramebuffer(R.__webglFramebuffer[$]),R.__webglDepthbuffer&&n.deleteRenderbuffer(R.__webglDepthbuffer[$]);else{if(n.deleteFramebuffer(R.__webglFramebuffer),R.__webglDepthbuffer&&n.deleteRenderbuffer(R.__webglDepthbuffer),R.__webglMultisampledFramebuffer&&n.deleteFramebuffer(R.__webglMultisampledFramebuffer),R.__webglColorRenderbuffer)for(let $=0;$<R.__webglColorRenderbuffer.length;$++)R.__webglColorRenderbuffer[$]&&n.deleteRenderbuffer(R.__webglColorRenderbuffer[$]);R.__webglDepthRenderbuffer&&n.deleteRenderbuffer(R.__webglDepthRenderbuffer)}if(y.isWebGLMultipleRenderTargets)for(let $=0,le=x.length;$<le;$++){const xe=i.get(x[$]);xe.__webglTexture&&(n.deleteTexture(xe.__webglTexture),a.memory.textures--),i.remove(x[$])}i.remove(x),i.remove(y)}let re=0;function se(){re=0}function W(){const y=re;return y>=l&&console.warn("THREE.WebGLTextures: Trying to use "+y+" texture units while this GPU supports only "+l),re+=1,y}function ae(y){const x=[];return x.push(y.wrapS),x.push(y.wrapT),x.push(y.wrapR||0),x.push(y.magFilter),x.push(y.minFilter),x.push(y.anisotropy),x.push(y.internalFormat),x.push(y.format),x.push(y.type),x.push(y.generateMipmaps),x.push(y.premultiplyAlpha),x.push(y.flipY),x.push(y.unpackAlignment),x.push(y.encoding),x.join()}function he(y,x){const R=i.get(y);if(y.isVideoTexture&&pe(y),y.isRenderTargetTexture===!1&&y.version>0&&R.__version!==y.version){const X=y.image;if(X===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(X.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{K(R,y,x);return}}t.bindTexture(3553,R.__webglTexture,33984+x)}function we(y,x){const R=i.get(y);if(y.version>0&&R.__version!==y.version){K(R,y,x);return}t.bindTexture(35866,R.__webglTexture,33984+x)}function j(y,x){const R=i.get(y);if(y.version>0&&R.__version!==y.version){K(R,y,x);return}t.bindTexture(32879,R.__webglTexture,33984+x)}function fe(y,x){const R=i.get(y);if(y.version>0&&R.__version!==y.version){q(R,y,x);return}t.bindTexture(34067,R.__webglTexture,33984+x)}const _e={[ga]:10497,[nn]:33071,[_a]:33648},k={[Pt]:9728,[ql]:9984,[_o]:9986,[Zt]:9729,[yg]:9985,[kr]:9987};function be(y,x,R){if(R?(n.texParameteri(y,10242,_e[x.wrapS]),n.texParameteri(y,10243,_e[x.wrapT]),(y===32879||y===35866)&&n.texParameteri(y,32882,_e[x.wrapR]),n.texParameteri(y,10240,k[x.magFilter]),n.texParameteri(y,10241,k[x.minFilter])):(n.texParameteri(y,10242,33071),n.texParameteri(y,10243,33071),(y===32879||y===35866)&&n.texParameteri(y,32882,33071),(x.wrapS!==nn||x.wrapT!==nn)&&console.warn("THREE.WebGLRenderer: Texture is not power of two. Texture.wrapS and Texture.wrapT should be set to THREE.ClampToEdgeWrapping."),n.texParameteri(y,10240,U(x.magFilter)),n.texParameteri(y,10241,U(x.minFilter)),x.minFilter!==Pt&&x.minFilter!==Zt&&console.warn("THREE.WebGLRenderer: Texture is not power of two. Texture.minFilter should be set to THREE.NearestFilter or THREE.LinearFilter.")),e.has("EXT_texture_filter_anisotropic")===!0){const X=e.get("EXT_texture_filter_anisotropic");if(x.magFilter===Pt||x.minFilter!==_o&&x.minFilter!==kr||x.type===pi&&e.has("OES_texture_float_linear")===!1||o===!1&&x.type===Vr&&e.has("OES_texture_half_float_linear")===!1)return;(x.anisotropy>1||i.get(x).__currentAnisotropy)&&(n.texParameterf(y,X.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(x.anisotropy,r.getMaxAnisotropy())),i.get(x).__currentAnisotropy=x.anisotropy)}}function I(y,x){let R=!1;y.__webglInit===void 0&&(y.__webglInit=!0,x.addEventListener("dispose",J));const X=x.source;let $=m.get(X);$===void 0&&($={},m.set(X,$));const le=ae(x);if(le!==y.__cacheKey){$[le]===void 0&&($[le]={texture:n.createTexture(),usedTimes:0},a.memory.textures++,R=!0),$[le].usedTimes++;const xe=$[y.__cacheKey];xe!==void 0&&($[y.__cacheKey].usedTimes--,xe.usedTimes===0&&z(x)),y.__cacheKey=le,y.__webglTexture=$[le].texture}return R}function K(y,x,R){let X=3553;(x.isDataArrayTexture||x.isCompressedArrayTexture)&&(X=35866),x.isData3DTexture&&(X=32879);const $=I(y,x),le=x.source;t.bindTexture(X,y.__webglTexture,33984+R);const xe=i.get(le);if(le.version!==xe.__version||$===!0){t.activeTexture(33984+R),n.pixelStorei(37440,x.flipY),n.pixelStorei(37441,x.premultiplyAlpha),n.pixelStorei(3317,x.unpackAlignment),n.pixelStorei(37443,0);const A=E(x)&&S(x.image)===!1;let F=_(x.image,A,!1,u);F=de(x,F);const ve=S(F)||o,ge=s.convert(x.format,x.encoding);let Me=s.convert(x.type),Ae=M(x.internalFormat,ge,Me,x.encoding,x.isVideoTexture);be(X,x,ve);let Ce;const Re=x.mipmaps,De=o&&x.isVideoTexture!==!0,je=xe.__version===void 0||$===!0,D=P(x,F,ve);if(x.isDepthTexture)Ae=6402,o?x.type===pi?Ae=36012:x.type===di?Ae=33190:x.type===Ji?Ae=35056:Ae=33189:x.type===pi&&console.error("WebGLRenderer: Floating point depth texture requires WebGL2."),x.format===_i&&Ae===6402&&x.type!==kf&&x.type!==di&&(console.warn("THREE.WebGLRenderer: Use UnsignedShortType or UnsignedIntType for DepthFormat DepthTexture."),x.type=di,Me=s.convert(x.type)),x.format===sr&&Ae===6402&&(Ae=34041,x.type!==Ji&&(console.warn("THREE.WebGLRenderer: Use UnsignedInt248Type for DepthStencilFormat DepthTexture."),x.type=Ji,Me=s.convert(x.type))),je&&(De?t.texStorage2D(3553,1,Ae,F.width,F.height):t.texImage2D(3553,0,Ae,F.width,F.height,0,ge,Me,null));else if(x.isDataTexture)if(Re.length>0&&ve){De&&je&&t.texStorage2D(3553,D,Ae,Re[0].width,Re[0].height);for(let te=0,me=Re.length;te<me;te++)Ce=Re[te],De?t.texSubImage2D(3553,te,0,0,Ce.width,Ce.height,ge,Me,Ce.data):t.texImage2D(3553,te,Ae,Ce.width,Ce.height,0,ge,Me,Ce.data);x.generateMipmaps=!1}else De?(je&&t.texStorage2D(3553,D,Ae,F.width,F.height),t.texSubImage2D(3553,0,0,0,F.width,F.height,ge,Me,F.data)):t.texImage2D(3553,0,Ae,F.width,F.height,0,ge,Me,F.data);else if(x.isCompressedTexture)if(x.isCompressedArrayTexture){De&&je&&t.texStorage3D(35866,D,Ae,Re[0].width,Re[0].height,F.depth);for(let te=0,me=Re.length;te<me;te++)Ce=Re[te],x.format!==rn?ge!==null?De?t.compressedTexSubImage3D(35866,te,0,0,0,Ce.width,Ce.height,F.depth,ge,Ce.data,0,0):t.compressedTexImage3D(35866,te,Ae,Ce.width,Ce.height,F.depth,0,Ce.data,0,0):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):De?t.texSubImage3D(35866,te,0,0,0,Ce.width,Ce.height,F.depth,ge,Me,Ce.data):t.texImage3D(35866,te,Ae,Ce.width,Ce.height,F.depth,0,ge,Me,Ce.data)}else{De&&je&&t.texStorage2D(3553,D,Ae,Re[0].width,Re[0].height);for(let te=0,me=Re.length;te<me;te++)Ce=Re[te],x.format!==rn?ge!==null?De?t.compressedTexSubImage2D(3553,te,0,0,Ce.width,Ce.height,ge,Ce.data):t.compressedTexImage2D(3553,te,Ae,Ce.width,Ce.height,0,Ce.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):De?t.texSubImage2D(3553,te,0,0,Ce.width,Ce.height,ge,Me,Ce.data):t.texImage2D(3553,te,Ae,Ce.width,Ce.height,0,ge,Me,Ce.data)}else if(x.isDataArrayTexture)De?(je&&t.texStorage3D(35866,D,Ae,F.width,F.height,F.depth),t.texSubImage3D(35866,0,0,0,0,F.width,F.height,F.depth,ge,Me,F.data)):t.texImage3D(35866,0,Ae,F.width,F.height,F.depth,0,ge,Me,F.data);else if(x.isData3DTexture)De?(je&&t.texStorage3D(32879,D,Ae,F.width,F.height,F.depth),t.texSubImage3D(32879,0,0,0,0,F.width,F.height,F.depth,ge,Me,F.data)):t.texImage3D(32879,0,Ae,F.width,F.height,F.depth,0,ge,Me,F.data);else if(x.isFramebufferTexture){if(je)if(De)t.texStorage2D(3553,D,Ae,F.width,F.height);else{let te=F.width,me=F.height;for(let Ee=0;Ee<D;Ee++)t.texImage2D(3553,Ee,Ae,te,me,0,ge,Me,null),te>>=1,me>>=1}}else if(Re.length>0&&ve){De&&je&&t.texStorage2D(3553,D,Ae,Re[0].width,Re[0].height);for(let te=0,me=Re.length;te<me;te++)Ce=Re[te],De?t.texSubImage2D(3553,te,0,0,ge,Me,Ce):t.texImage2D(3553,te,Ae,ge,Me,Ce);x.generateMipmaps=!1}else De?(je&&t.texStorage2D(3553,D,Ae,F.width,F.height),t.texSubImage2D(3553,0,0,0,ge,Me,F)):t.texImage2D(3553,0,Ae,ge,Me,F);L(x,ve)&&O(X),xe.__version=le.version,x.onUpdate&&x.onUpdate(x)}y.__version=x.version}function q(y,x,R){if(x.image.length!==6)return;const X=I(y,x),$=x.source;t.bindTexture(34067,y.__webglTexture,33984+R);const le=i.get($);if($.version!==le.__version||X===!0){t.activeTexture(33984+R),n.pixelStorei(37440,x.flipY),n.pixelStorei(37441,x.premultiplyAlpha),n.pixelStorei(3317,x.unpackAlignment),n.pixelStorei(37443,0);const xe=x.isCompressedTexture||x.image[0].isCompressedTexture,A=x.image[0]&&x.image[0].isDataTexture,F=[];for(let te=0;te<6;te++)!xe&&!A?F[te]=_(x.image[te],!1,!0,c):F[te]=A?x.image[te].image:x.image[te],F[te]=de(x,F[te]);const ve=F[0],ge=S(ve)||o,Me=s.convert(x.format,x.encoding),Ae=s.convert(x.type),Ce=M(x.internalFormat,Me,Ae,x.encoding),Re=o&&x.isVideoTexture!==!0,De=le.__version===void 0||X===!0;let je=P(x,ve,ge);be(34067,x,ge);let D;if(xe){Re&&De&&t.texStorage2D(34067,je,Ce,ve.width,ve.height);for(let te=0;te<6;te++){D=F[te].mipmaps;for(let me=0;me<D.length;me++){const Ee=D[me];x.format!==rn?Me!==null?Re?t.compressedTexSubImage2D(34069+te,me,0,0,Ee.width,Ee.height,Me,Ee.data):t.compressedTexImage2D(34069+te,me,Ce,Ee.width,Ee.height,0,Ee.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Re?t.texSubImage2D(34069+te,me,0,0,Ee.width,Ee.height,Me,Ae,Ee.data):t.texImage2D(34069+te,me,Ce,Ee.width,Ee.height,0,Me,Ae,Ee.data)}}}else{D=x.mipmaps,Re&&De&&(D.length>0&&je++,t.texStorage2D(34067,je,Ce,F[0].width,F[0].height));for(let te=0;te<6;te++)if(A){Re?t.texSubImage2D(34069+te,0,0,0,F[te].width,F[te].height,Me,Ae,F[te].data):t.texImage2D(34069+te,0,Ce,F[te].width,F[te].height,0,Me,Ae,F[te].data);for(let me=0;me<D.length;me++){const Pe=D[me].image[te].image;Re?t.texSubImage2D(34069+te,me+1,0,0,Pe.width,Pe.height,Me,Ae,Pe.data):t.texImage2D(34069+te,me+1,Ce,Pe.width,Pe.height,0,Me,Ae,Pe.data)}}else{Re?t.texSubImage2D(34069+te,0,0,0,Me,Ae,F[te]):t.texImage2D(34069+te,0,Ce,Me,Ae,F[te]);for(let me=0;me<D.length;me++){const Ee=D[me];Re?t.texSubImage2D(34069+te,me+1,0,0,Me,Ae,Ee.image[te]):t.texImage2D(34069+te,me+1,Ce,Me,Ae,Ee.image[te])}}}L(x,ge)&&O(34067),le.__version=$.version,x.onUpdate&&x.onUpdate(x)}y.__version=x.version}function oe(y,x,R,X,$){const le=s.convert(R.format,R.encoding),xe=s.convert(R.type),A=M(R.internalFormat,le,xe,R.encoding);i.get(x).__hasExternalTextures||($===32879||$===35866?t.texImage3D($,0,A,x.width,x.height,x.depth,0,le,xe,null):t.texImage2D($,0,A,x.width,x.height,0,le,xe,null)),t.bindFramebuffer(36160,y),ue(x)?h.framebufferTexture2DMultisampleEXT(36160,X,$,i.get(R).__webglTexture,0,ee(x)):($===3553||$>=34069&&$<=34074)&&n.framebufferTexture2D(36160,X,$,i.get(R).__webglTexture,0),t.bindFramebuffer(36160,null)}function Se(y,x,R){if(n.bindRenderbuffer(36161,y),x.depthBuffer&&!x.stencilBuffer){let X=33189;if(R||ue(x)){const $=x.depthTexture;$&&$.isDepthTexture&&($.type===pi?X=36012:$.type===di&&(X=33190));const le=ee(x);ue(x)?h.renderbufferStorageMultisampleEXT(36161,le,X,x.width,x.height):n.renderbufferStorageMultisample(36161,le,X,x.width,x.height)}else n.renderbufferStorage(36161,X,x.width,x.height);n.framebufferRenderbuffer(36160,36096,36161,y)}else if(x.depthBuffer&&x.stencilBuffer){const X=ee(x);R&&ue(x)===!1?n.renderbufferStorageMultisample(36161,X,35056,x.width,x.height):ue(x)?h.renderbufferStorageMultisampleEXT(36161,X,35056,x.width,x.height):n.renderbufferStorage(36161,34041,x.width,x.height),n.framebufferRenderbuffer(36160,33306,36161,y)}else{const X=x.isWebGLMultipleRenderTargets===!0?x.texture:[x.texture];for(let $=0;$<X.length;$++){const le=X[$],xe=s.convert(le.format,le.encoding),A=s.convert(le.type),F=M(le.internalFormat,xe,A,le.encoding),ve=ee(x);R&&ue(x)===!1?n.renderbufferStorageMultisample(36161,ve,F,x.width,x.height):ue(x)?h.renderbufferStorageMultisampleEXT(36161,ve,F,x.width,x.height):n.renderbufferStorage(36161,F,x.width,x.height)}}n.bindRenderbuffer(36161,null)}function Te(y,x){if(x&&x.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(36160,y),!(x.depthTexture&&x.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!i.get(x.depthTexture).__webglTexture||x.depthTexture.image.width!==x.width||x.depthTexture.image.height!==x.height)&&(x.depthTexture.image.width=x.width,x.depthTexture.image.height=x.height,x.depthTexture.needsUpdate=!0),he(x.depthTexture,0);const X=i.get(x.depthTexture).__webglTexture,$=ee(x);if(x.depthTexture.format===_i)ue(x)?h.framebufferTexture2DMultisampleEXT(36160,36096,3553,X,0,$):n.framebufferTexture2D(36160,36096,3553,X,0);else if(x.depthTexture.format===sr)ue(x)?h.framebufferTexture2DMultisampleEXT(36160,33306,3553,X,0,$):n.framebufferTexture2D(36160,33306,3553,X,0);else throw new Error("Unknown depthTexture format")}function w(y){const x=i.get(y),R=y.isWebGLCubeRenderTarget===!0;if(y.depthTexture&&!x.__autoAllocateDepthBuffer){if(R)throw new Error("target.depthTexture not supported in Cube render targets");Te(x.__webglFramebuffer,y)}else if(R){x.__webglDepthbuffer=[];for(let X=0;X<6;X++)t.bindFramebuffer(36160,x.__webglFramebuffer[X]),x.__webglDepthbuffer[X]=n.createRenderbuffer(),Se(x.__webglDepthbuffer[X],y,!1)}else t.bindFramebuffer(36160,x.__webglFramebuffer),x.__webglDepthbuffer=n.createRenderbuffer(),Se(x.__webglDepthbuffer,y,!1);t.bindFramebuffer(36160,null)}function C(y,x,R){const X=i.get(y);x!==void 0&&oe(X.__webglFramebuffer,y,y.texture,36064,3553),R!==void 0&&w(y)}function B(y){const x=y.texture,R=i.get(y),X=i.get(x);y.addEventListener("dispose",ce),y.isWebGLMultipleRenderTargets!==!0&&(X.__webglTexture===void 0&&(X.__webglTexture=n.createTexture()),X.__version=x.version,a.memory.textures++);const $=y.isWebGLCubeRenderTarget===!0,le=y.isWebGLMultipleRenderTargets===!0,xe=S(y)||o;if($){R.__webglFramebuffer=[];for(let A=0;A<6;A++)R.__webglFramebuffer[A]=n.createFramebuffer()}else{if(R.__webglFramebuffer=n.createFramebuffer(),le)if(r.drawBuffers){const A=y.texture;for(let F=0,ve=A.length;F<ve;F++){const ge=i.get(A[F]);ge.__webglTexture===void 0&&(ge.__webglTexture=n.createTexture(),a.memory.textures++)}}else console.warn("THREE.WebGLRenderer: WebGLMultipleRenderTargets can only be used with WebGL2 or WEBGL_draw_buffers extension.");if(o&&y.samples>0&&ue(y)===!1){const A=le?x:[x];R.__webglMultisampledFramebuffer=n.createFramebuffer(),R.__webglColorRenderbuffer=[],t.bindFramebuffer(36160,R.__webglMultisampledFramebuffer);for(let F=0;F<A.length;F++){const ve=A[F];R.__webglColorRenderbuffer[F]=n.createRenderbuffer(),n.bindRenderbuffer(36161,R.__webglColorRenderbuffer[F]);const ge=s.convert(ve.format,ve.encoding),Me=s.convert(ve.type),Ae=M(ve.internalFormat,ge,Me,ve.encoding,y.isXRRenderTarget===!0),Ce=ee(y);n.renderbufferStorageMultisample(36161,Ce,Ae,y.width,y.height),n.framebufferRenderbuffer(36160,36064+F,36161,R.__webglColorRenderbuffer[F])}n.bindRenderbuffer(36161,null),y.depthBuffer&&(R.__webglDepthRenderbuffer=n.createRenderbuffer(),Se(R.__webglDepthRenderbuffer,y,!0)),t.bindFramebuffer(36160,null)}}if($){t.bindTexture(34067,X.__webglTexture),be(34067,x,xe);for(let A=0;A<6;A++)oe(R.__webglFramebuffer[A],y,x,36064,34069+A);L(x,xe)&&O(34067),t.unbindTexture()}else if(le){const A=y.texture;for(let F=0,ve=A.length;F<ve;F++){const ge=A[F],Me=i.get(ge);t.bindTexture(3553,Me.__webglTexture),be(3553,ge,xe),oe(R.__webglFramebuffer,y,ge,36064+F,3553),L(ge,xe)&&O(3553)}t.unbindTexture()}else{let A=3553;(y.isWebGL3DRenderTarget||y.isWebGLArrayRenderTarget)&&(o?A=y.isWebGL3DRenderTarget?32879:35866:console.error("THREE.WebGLTextures: THREE.Data3DTexture and THREE.DataArrayTexture only supported with WebGL2.")),t.bindTexture(A,X.__webglTexture),be(A,x,xe),oe(R.__webglFramebuffer,y,x,36064,A),L(x,xe)&&O(A),t.unbindTexture()}y.depthBuffer&&w(y)}function ne(y){const x=S(y)||o,R=y.isWebGLMultipleRenderTargets===!0?y.texture:[y.texture];for(let X=0,$=R.length;X<$;X++){const le=R[X];if(L(le,x)){const xe=y.isWebGLCubeRenderTarget?34067:3553,A=i.get(le).__webglTexture;t.bindTexture(xe,A),O(xe),t.unbindTexture()}}}function Y(y){if(o&&y.samples>0&&ue(y)===!1){const x=y.isWebGLMultipleRenderTargets?y.texture:[y.texture],R=y.width,X=y.height;let $=16384;const le=[],xe=y.stencilBuffer?33306:36096,A=i.get(y),F=y.isWebGLMultipleRenderTargets===!0;if(F)for(let ve=0;ve<x.length;ve++)t.bindFramebuffer(36160,A.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(36160,36064+ve,36161,null),t.bindFramebuffer(36160,A.__webglFramebuffer),n.framebufferTexture2D(36009,36064+ve,3553,null,0);t.bindFramebuffer(36008,A.__webglMultisampledFramebuffer),t.bindFramebuffer(36009,A.__webglFramebuffer);for(let ve=0;ve<x.length;ve++){le.push(36064+ve),y.depthBuffer&&le.push(xe);const ge=A.__ignoreDepthValues!==void 0?A.__ignoreDepthValues:!1;if(ge===!1&&(y.depthBuffer&&($|=256),y.stencilBuffer&&($|=1024)),F&&n.framebufferRenderbuffer(36008,36064,36161,A.__webglColorRenderbuffer[ve]),ge===!0&&(n.invalidateFramebuffer(36008,[xe]),n.invalidateFramebuffer(36009,[xe])),F){const Me=i.get(x[ve]).__webglTexture;n.framebufferTexture2D(36009,36064,3553,Me,0)}n.blitFramebuffer(0,0,R,X,0,0,R,X,$,9728),d&&n.invalidateFramebuffer(36008,le)}if(t.bindFramebuffer(36008,null),t.bindFramebuffer(36009,null),F)for(let ve=0;ve<x.length;ve++){t.bindFramebuffer(36160,A.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(36160,36064+ve,36161,A.__webglColorRenderbuffer[ve]);const ge=i.get(x[ve]).__webglTexture;t.bindFramebuffer(36160,A.__webglFramebuffer),n.framebufferTexture2D(36009,36064+ve,3553,ge,0)}t.bindFramebuffer(36009,A.__webglMultisampledFramebuffer)}}function ee(y){return Math.min(f,y.samples)}function ue(y){const x=i.get(y);return o&&y.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&x.__useRenderToTexture!==!1}function pe(y){const x=a.render.frame;g.get(y)!==x&&(g.set(y,x),y.update())}function de(y,x){const R=y.encoding,X=y.format,$=y.type;return y.isCompressedTexture===!0||y.isVideoTexture===!0||y.format===va||R!==yi&&(R===Qe?o===!1?e.has("EXT_sRGB")===!0&&X===rn?(y.format=va,y.minFilter=Zt,y.generateMipmaps=!1):x=Wf.sRGBToLinear(x):(X!==rn||$!==xi)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture encoding:",R)),x}this.allocateTextureUnit=W,this.resetTextureUnits=se,this.setTexture2D=he,this.setTexture2DArray=we,this.setTexture3D=j,this.setTextureCube=fe,this.rebindTextures=C,this.setupRenderTarget=B,this.updateRenderTargetMipmap=ne,this.updateMultisampleRenderTarget=Y,this.setupDepthRenderbuffer=w,this.setupFrameBufferTexture=oe,this.useMultisampledRTT=ue}function Gy(n,e,t){const i=t.isWebGL2;function r(s,a=null){let o;if(s===xi)return 5121;if(s===wg)return 32819;if(s===Eg)return 32820;if(s===bg)return 5120;if(s===Mg)return 5122;if(s===kf)return 5123;if(s===Sg)return 5124;if(s===di)return 5125;if(s===pi)return 5126;if(s===Vr)return i?5131:(o=e.get("OES_texture_half_float"),o!==null?o.HALF_FLOAT_OES:null);if(s===Tg)return 6406;if(s===rn)return 6408;if(s===Ag)return 6409;if(s===Cg)return 6410;if(s===_i)return 6402;if(s===sr)return 34041;if(s===va)return o=e.get("EXT_sRGB"),o!==null?o.SRGB_ALPHA_EXT:null;if(s===Pg)return 6403;if(s===Lg)return 36244;if(s===Rg)return 33319;if(s===Dg)return 33320;if(s===Ig)return 36249;if(s===vo||s===xo||s===yo||s===bo)if(a===Qe)if(o=e.get("WEBGL_compressed_texture_s3tc_srgb"),o!==null){if(s===vo)return o.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(s===xo)return o.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(s===yo)return o.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(s===bo)return o.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(o=e.get("WEBGL_compressed_texture_s3tc"),o!==null){if(s===vo)return o.COMPRESSED_RGB_S3TC_DXT1_EXT;if(s===xo)return o.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(s===yo)return o.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(s===bo)return o.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(s===Yl||s===Zl||s===$l||s===Kl)if(o=e.get("WEBGL_compressed_texture_pvrtc"),o!==null){if(s===Yl)return o.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(s===Zl)return o.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(s===$l)return o.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(s===Kl)return o.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(s===Og)return o=e.get("WEBGL_compressed_texture_etc1"),o!==null?o.COMPRESSED_RGB_ETC1_WEBGL:null;if(s===Jl||s===Ql)if(o=e.get("WEBGL_compressed_texture_etc"),o!==null){if(s===Jl)return a===Qe?o.COMPRESSED_SRGB8_ETC2:o.COMPRESSED_RGB8_ETC2;if(s===Ql)return a===Qe?o.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:o.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(s===ec||s===tc||s===nc||s===ic||s===rc||s===sc||s===oc||s===ac||s===lc||s===cc||s===uc||s===fc||s===hc||s===dc)if(o=e.get("WEBGL_compressed_texture_astc"),o!==null){if(s===ec)return a===Qe?o.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:o.COMPRESSED_RGBA_ASTC_4x4_KHR;if(s===tc)return a===Qe?o.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:o.COMPRESSED_RGBA_ASTC_5x4_KHR;if(s===nc)return a===Qe?o.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:o.COMPRESSED_RGBA_ASTC_5x5_KHR;if(s===ic)return a===Qe?o.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:o.COMPRESSED_RGBA_ASTC_6x5_KHR;if(s===rc)return a===Qe?o.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:o.COMPRESSED_RGBA_ASTC_6x6_KHR;if(s===sc)return a===Qe?o.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:o.COMPRESSED_RGBA_ASTC_8x5_KHR;if(s===oc)return a===Qe?o.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:o.COMPRESSED_RGBA_ASTC_8x6_KHR;if(s===ac)return a===Qe?o.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:o.COMPRESSED_RGBA_ASTC_8x8_KHR;if(s===lc)return a===Qe?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:o.COMPRESSED_RGBA_ASTC_10x5_KHR;if(s===cc)return a===Qe?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:o.COMPRESSED_RGBA_ASTC_10x6_KHR;if(s===uc)return a===Qe?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:o.COMPRESSED_RGBA_ASTC_10x8_KHR;if(s===fc)return a===Qe?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:o.COMPRESSED_RGBA_ASTC_10x10_KHR;if(s===hc)return a===Qe?o.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:o.COMPRESSED_RGBA_ASTC_12x10_KHR;if(s===dc)return a===Qe?o.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:o.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(s===Mo)if(o=e.get("EXT_texture_compression_bptc"),o!==null){if(s===Mo)return a===Qe?o.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:o.COMPRESSED_RGBA_BPTC_UNORM_EXT}else return null;if(s===Fg||s===pc||s===mc||s===gc)if(o=e.get("EXT_texture_compression_rgtc"),o!==null){if(s===Mo)return o.COMPRESSED_RED_RGTC1_EXT;if(s===pc)return o.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(s===mc)return o.COMPRESSED_RED_GREEN_RGTC2_EXT;if(s===gc)return o.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return s===Ji?i?34042:(o=e.get("WEBGL_depth_texture"),o!==null?o.UNSIGNED_INT_24_8_WEBGL:null):n[s]!==void 0?n[s]:null}return{convert:r}}class ky extends Wt{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}}class xs extends mt{constructor(){super(),this.isGroup=!0,this.type="Group"}}const Vy={type:"move"};class Yo{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new xs,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new xs,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new N,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new N),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new xs,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new N,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new N),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const t=this._hand;if(t)for(const i of e.hand.values())this._getHandJoint(t,i)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,t,i){let r=null,s=null,a=null;const o=this._targetRay,l=this._grip,c=this._hand;if(e&&t.session.visibilityState!=="visible-blurred"){if(c&&e.hand){a=!0;for(const p of e.hand.values()){const m=t.getJointPose(p,i),v=this._getHandJoint(c,p);m!==null&&(v.matrix.fromArray(m.transform.matrix),v.matrix.decompose(v.position,v.rotation,v.scale),v.jointRadius=m.radius),v.visible=m!==null}const u=c.joints["index-finger-tip"],f=c.joints["thumb-tip"],h=u.position.distanceTo(f.position),d=.02,g=.005;c.inputState.pinching&&h>d+g?(c.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!c.inputState.pinching&&h<=d-g&&(c.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else l!==null&&e.gripSpace&&(s=t.getPose(e.gripSpace,i),s!==null&&(l.matrix.fromArray(s.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),s.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(s.linearVelocity)):l.hasLinearVelocity=!1,s.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(s.angularVelocity)):l.hasAngularVelocity=!1));o!==null&&(r=t.getPose(e.targetRaySpace,i),r===null&&s!==null&&(r=s),r!==null&&(o.matrix.fromArray(r.transform.matrix),o.matrix.decompose(o.position,o.rotation,o.scale),r.linearVelocity?(o.hasLinearVelocity=!0,o.linearVelocity.copy(r.linearVelocity)):o.hasLinearVelocity=!1,r.angularVelocity?(o.hasAngularVelocity=!0,o.angularVelocity.copy(r.angularVelocity)):o.hasAngularVelocity=!1,this.dispatchEvent(Vy)))}return o!==null&&(o.visible=r!==null),l!==null&&(l.visible=s!==null),c!==null&&(c.visible=a!==null),this}_getHandJoint(e,t){if(e.joints[t.jointName]===void 0){const i=new xs;i.matrixAutoUpdate=!1,i.visible=!1,e.joints[t.jointName]=i,e.add(i)}return e.joints[t.jointName]}}class Hy extends Nt{constructor(e,t,i,r,s,a,o,l,c,u){if(u=u!==void 0?u:_i,u!==_i&&u!==sr)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");i===void 0&&u===_i&&(i=di),i===void 0&&u===sr&&(i=Ji),super(null,r,s,a,o,l,u,i,c),this.isDepthTexture=!0,this.image={width:e,height:t},this.magFilter=o!==void 0?o:Pt,this.minFilter=l!==void 0?l:Pt,this.flipY=!1,this.generateMipmaps=!1}}class Wy extends wi{constructor(e,t){super();const i=this;let r=null,s=1,a=null,o="local-floor",l=1,c=null,u=null,f=null,h=null,d=null,g=null;const p=t.getContextAttributes();let m=null,v=null;const b=[],_=[],S=new Set,E=new Map,L=new Wt;L.layers.enable(1),L.viewport=new _t;const O=new Wt;O.layers.enable(2),O.viewport=new _t;const M=[L,O],P=new ky;P.layers.enable(1),P.layers.enable(2);let U=null,J=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(j){let fe=b[j];return fe===void 0&&(fe=new Yo,b[j]=fe),fe.getTargetRaySpace()},this.getControllerGrip=function(j){let fe=b[j];return fe===void 0&&(fe=new Yo,b[j]=fe),fe.getGripSpace()},this.getHand=function(j){let fe=b[j];return fe===void 0&&(fe=new Yo,b[j]=fe),fe.getHandSpace()};function ce(j){const fe=_.indexOf(j.inputSource);if(fe===-1)return;const _e=b[fe];_e!==void 0&&_e.dispatchEvent({type:j.type,data:j.inputSource})}function V(){r.removeEventListener("select",ce),r.removeEventListener("selectstart",ce),r.removeEventListener("selectend",ce),r.removeEventListener("squeeze",ce),r.removeEventListener("squeezestart",ce),r.removeEventListener("squeezeend",ce),r.removeEventListener("end",V),r.removeEventListener("inputsourceschange",z);for(let j=0;j<b.length;j++){const fe=_[j];fe!==null&&(_[j]=null,b[j].disconnect(fe))}U=null,J=null,e.setRenderTarget(m),d=null,h=null,f=null,r=null,v=null,we.stop(),i.isPresenting=!1,i.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(j){s=j,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(j){o=j,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(j){c=j},this.getBaseLayer=function(){return h!==null?h:d},this.getBinding=function(){return f},this.getFrame=function(){return g},this.getSession=function(){return r},this.setSession=async function(j){if(r=j,r!==null){if(m=e.getRenderTarget(),r.addEventListener("select",ce),r.addEventListener("selectstart",ce),r.addEventListener("selectend",ce),r.addEventListener("squeeze",ce),r.addEventListener("squeezestart",ce),r.addEventListener("squeezeend",ce),r.addEventListener("end",V),r.addEventListener("inputsourceschange",z),p.xrCompatible!==!0&&await t.makeXRCompatible(),r.renderState.layers===void 0||e.capabilities.isWebGL2===!1){const fe={antialias:r.renderState.layers===void 0?p.antialias:!0,alpha:p.alpha,depth:p.depth,stencil:p.stencil,framebufferScaleFactor:s};d=new XRWebGLLayer(r,t,fe),r.updateRenderState({baseLayer:d}),v=new Mi(d.framebufferWidth,d.framebufferHeight,{format:rn,type:xi,encoding:e.outputEncoding,stencilBuffer:p.stencil})}else{let fe=null,_e=null,k=null;p.depth&&(k=p.stencil?35056:33190,fe=p.stencil?sr:_i,_e=p.stencil?Ji:di);const be={colorFormat:32856,depthFormat:k,scaleFactor:s};f=new XRWebGLBinding(r,t),h=f.createProjectionLayer(be),r.updateRenderState({layers:[h]}),v=new Mi(h.textureWidth,h.textureHeight,{format:rn,type:xi,depthTexture:new Hy(h.textureWidth,h.textureHeight,_e,void 0,void 0,void 0,void 0,void 0,void 0,fe),stencilBuffer:p.stencil,encoding:e.outputEncoding,samples:p.antialias?4:0});const I=e.properties.get(v);I.__ignoreDepthValues=h.ignoreDepthValues}v.isXRRenderTarget=!0,this.setFoveation(l),c=null,a=await r.requestReferenceSpace(o),we.setContext(r),we.start(),i.isPresenting=!0,i.dispatchEvent({type:"sessionstart"})}};function z(j){for(let fe=0;fe<j.removed.length;fe++){const _e=j.removed[fe],k=_.indexOf(_e);k>=0&&(_[k]=null,b[k].disconnect(_e))}for(let fe=0;fe<j.added.length;fe++){const _e=j.added[fe];let k=_.indexOf(_e);if(k===-1){for(let I=0;I<b.length;I++)if(I>=_.length){_.push(_e),k=I;break}else if(_[I]===null){_[I]=_e,k=I;break}if(k===-1)break}const be=b[k];be&&be.connect(_e)}}const Z=new N,re=new N;function se(j,fe,_e){Z.setFromMatrixPosition(fe.matrixWorld),re.setFromMatrixPosition(_e.matrixWorld);const k=Z.distanceTo(re),be=fe.projectionMatrix.elements,I=_e.projectionMatrix.elements,K=be[14]/(be[10]-1),q=be[14]/(be[10]+1),oe=(be[9]+1)/be[5],Se=(be[9]-1)/be[5],Te=(be[8]-1)/be[0],w=(I[8]+1)/I[0],C=K*Te,B=K*w,ne=k/(-Te+w),Y=ne*-Te;fe.matrixWorld.decompose(j.position,j.quaternion,j.scale),j.translateX(Y),j.translateZ(ne),j.matrixWorld.compose(j.position,j.quaternion,j.scale),j.matrixWorldInverse.copy(j.matrixWorld).invert();const ee=K+ne,ue=q+ne,pe=C-Y,de=B+(k-Y),y=oe*q/ue*ee,x=Se*q/ue*ee;j.projectionMatrix.makePerspective(pe,de,y,x,ee,ue)}function W(j,fe){fe===null?j.matrixWorld.copy(j.matrix):j.matrixWorld.multiplyMatrices(fe.matrixWorld,j.matrix),j.matrixWorldInverse.copy(j.matrixWorld).invert()}this.updateCamera=function(j){if(r===null)return;P.near=O.near=L.near=j.near,P.far=O.far=L.far=j.far,(U!==P.near||J!==P.far)&&(r.updateRenderState({depthNear:P.near,depthFar:P.far}),U=P.near,J=P.far);const fe=j.parent,_e=P.cameras;W(P,fe);for(let be=0;be<_e.length;be++)W(_e[be],fe);P.matrixWorld.decompose(P.position,P.quaternion,P.scale),j.matrix.copy(P.matrix),j.matrix.decompose(j.position,j.quaternion,j.scale);const k=j.children;for(let be=0,I=k.length;be<I;be++)k[be].updateMatrixWorld(!0);_e.length===2?se(P,L,O):P.projectionMatrix.copy(L.projectionMatrix)},this.getCamera=function(){return P},this.getFoveation=function(){if(!(h===null&&d===null))return l},this.setFoveation=function(j){l=j,h!==null&&(h.fixedFoveation=j),d!==null&&d.fixedFoveation!==void 0&&(d.fixedFoveation=j)},this.getPlanes=function(){return S};let ae=null;function he(j,fe){if(u=fe.getViewerPose(c||a),g=fe,u!==null){const _e=u.views;d!==null&&(e.setRenderTargetFramebuffer(v,d.framebuffer),e.setRenderTarget(v));let k=!1;_e.length!==P.cameras.length&&(P.cameras.length=0,k=!0);for(let be=0;be<_e.length;be++){const I=_e[be];let K=null;if(d!==null)K=d.getViewport(I);else{const oe=f.getViewSubImage(h,I);K=oe.viewport,be===0&&(e.setRenderTargetTextures(v,oe.colorTexture,h.ignoreDepthValues?void 0:oe.depthStencilTexture),e.setRenderTarget(v))}let q=M[be];q===void 0&&(q=new Wt,q.layers.enable(be),q.viewport=new _t,M[be]=q),q.matrix.fromArray(I.transform.matrix),q.projectionMatrix.fromArray(I.projectionMatrix),q.viewport.set(K.x,K.y,K.width,K.height),be===0&&P.matrix.copy(q.matrix),k===!0&&P.cameras.push(q)}}for(let _e=0;_e<b.length;_e++){const k=_[_e],be=b[_e];k!==null&&be!==void 0&&be.update(k,fe,c||a)}if(ae&&ae(j,fe),fe.detectedPlanes){i.dispatchEvent({type:"planesdetected",data:fe.detectedPlanes});let _e=null;for(const k of S)fe.detectedPlanes.has(k)||(_e===null&&(_e=[]),_e.push(k));if(_e!==null)for(const k of _e)S.delete(k),E.delete(k),i.dispatchEvent({type:"planeremoved",data:k});for(const k of fe.detectedPlanes)if(!S.has(k))S.add(k),E.set(k,fe.lastChangedTime),i.dispatchEvent({type:"planeadded",data:k});else{const be=E.get(k);k.lastChangedTime>be&&(E.set(k,k.lastChangedTime),i.dispatchEvent({type:"planechanged",data:k}))}}g=null}const we=new eh;we.setAnimationLoop(he),this.setAnimationLoop=function(j){ae=j},this.dispose=function(){}}}function jy(n,e){function t(p,m){m.color.getRGB(p.fogColor.value,Kf(n)),m.isFog?(p.fogNear.value=m.near,p.fogFar.value=m.far):m.isFogExp2&&(p.fogDensity.value=m.density)}function i(p,m,v,b,_){m.isMeshBasicMaterial||m.isMeshLambertMaterial?r(p,m):m.isMeshToonMaterial?(r(p,m),u(p,m)):m.isMeshPhongMaterial?(r(p,m),c(p,m)):m.isMeshStandardMaterial?(r(p,m),f(p,m),m.isMeshPhysicalMaterial&&h(p,m,_)):m.isMeshMatcapMaterial?(r(p,m),d(p,m)):m.isMeshDepthMaterial?r(p,m):m.isMeshDistanceMaterial?(r(p,m),g(p,m)):m.isMeshNormalMaterial?r(p,m):m.isLineBasicMaterial?(s(p,m),m.isLineDashedMaterial&&a(p,m)):m.isPointsMaterial?o(p,m,v,b):m.isSpriteMaterial?l(p,m):m.isShadowMaterial?(p.color.value.copy(m.color),p.opacity.value=m.opacity):m.isShaderMaterial&&(m.uniformsNeedUpdate=!1)}function r(p,m){p.opacity.value=m.opacity,m.color&&p.diffuse.value.copy(m.color),m.emissive&&p.emissive.value.copy(m.emissive).multiplyScalar(m.emissiveIntensity),m.map&&(p.map.value=m.map),m.alphaMap&&(p.alphaMap.value=m.alphaMap),m.bumpMap&&(p.bumpMap.value=m.bumpMap,p.bumpScale.value=m.bumpScale,m.side===Ft&&(p.bumpScale.value*=-1)),m.displacementMap&&(p.displacementMap.value=m.displacementMap,p.displacementScale.value=m.displacementScale,p.displacementBias.value=m.displacementBias),m.emissiveMap&&(p.emissiveMap.value=m.emissiveMap),m.normalMap&&(p.normalMap.value=m.normalMap,p.normalScale.value.copy(m.normalScale),m.side===Ft&&p.normalScale.value.negate()),m.specularMap&&(p.specularMap.value=m.specularMap),m.alphaTest>0&&(p.alphaTest.value=m.alphaTest);const v=e.get(m).envMap;if(v&&(p.envMap.value=v,p.flipEnvMap.value=v.isCubeTexture&&v.isRenderTargetTexture===!1?-1:1,p.reflectivity.value=m.reflectivity,p.ior.value=m.ior,p.refractionRatio.value=m.refractionRatio),m.lightMap){p.lightMap.value=m.lightMap;const S=n.useLegacyLights===!0?Math.PI:1;p.lightMapIntensity.value=m.lightMapIntensity*S}m.aoMap&&(p.aoMap.value=m.aoMap,p.aoMapIntensity.value=m.aoMapIntensity);let b;m.map?b=m.map:m.specularMap?b=m.specularMap:m.displacementMap?b=m.displacementMap:m.normalMap?b=m.normalMap:m.bumpMap?b=m.bumpMap:m.roughnessMap?b=m.roughnessMap:m.metalnessMap?b=m.metalnessMap:m.alphaMap?b=m.alphaMap:m.emissiveMap?b=m.emissiveMap:m.clearcoatMap?b=m.clearcoatMap:m.clearcoatNormalMap?b=m.clearcoatNormalMap:m.clearcoatRoughnessMap?b=m.clearcoatRoughnessMap:m.iridescenceMap?b=m.iridescenceMap:m.iridescenceThicknessMap?b=m.iridescenceThicknessMap:m.specularIntensityMap?b=m.specularIntensityMap:m.specularColorMap?b=m.specularColorMap:m.transmissionMap?b=m.transmissionMap:m.thicknessMap?b=m.thicknessMap:m.sheenColorMap?b=m.sheenColorMap:m.sheenRoughnessMap&&(b=m.sheenRoughnessMap),b!==void 0&&(b.isWebGLRenderTarget&&(b=b.texture),b.matrixAutoUpdate===!0&&b.updateMatrix(),p.uvTransform.value.copy(b.matrix));let _;m.aoMap?_=m.aoMap:m.lightMap&&(_=m.lightMap),_!==void 0&&(_.isWebGLRenderTarget&&(_=_.texture),_.matrixAutoUpdate===!0&&_.updateMatrix(),p.uv2Transform.value.copy(_.matrix))}function s(p,m){p.diffuse.value.copy(m.color),p.opacity.value=m.opacity}function a(p,m){p.dashSize.value=m.dashSize,p.totalSize.value=m.dashSize+m.gapSize,p.scale.value=m.scale}function o(p,m,v,b){p.diffuse.value.copy(m.color),p.opacity.value=m.opacity,p.size.value=m.size*v,p.scale.value=b*.5,m.map&&(p.map.value=m.map),m.alphaMap&&(p.alphaMap.value=m.alphaMap),m.alphaTest>0&&(p.alphaTest.value=m.alphaTest);let _;m.map?_=m.map:m.alphaMap&&(_=m.alphaMap),_!==void 0&&(_.matrixAutoUpdate===!0&&_.updateMatrix(),p.uvTransform.value.copy(_.matrix))}function l(p,m){p.diffuse.value.copy(m.color),p.opacity.value=m.opacity,p.rotation.value=m.rotation,m.map&&(p.map.value=m.map),m.alphaMap&&(p.alphaMap.value=m.alphaMap),m.alphaTest>0&&(p.alphaTest.value=m.alphaTest);let v;m.map?v=m.map:m.alphaMap&&(v=m.alphaMap),v!==void 0&&(v.matrixAutoUpdate===!0&&v.updateMatrix(),p.uvTransform.value.copy(v.matrix))}function c(p,m){p.specular.value.copy(m.specular),p.shininess.value=Math.max(m.shininess,1e-4)}function u(p,m){m.gradientMap&&(p.gradientMap.value=m.gradientMap)}function f(p,m){p.roughness.value=m.roughness,p.metalness.value=m.metalness,m.roughnessMap&&(p.roughnessMap.value=m.roughnessMap),m.metalnessMap&&(p.metalnessMap.value=m.metalnessMap),e.get(m).envMap&&(p.envMapIntensity.value=m.envMapIntensity)}function h(p,m,v){p.ior.value=m.ior,m.sheen>0&&(p.sheenColor.value.copy(m.sheenColor).multiplyScalar(m.sheen),p.sheenRoughness.value=m.sheenRoughness,m.sheenColorMap&&(p.sheenColorMap.value=m.sheenColorMap),m.sheenRoughnessMap&&(p.sheenRoughnessMap.value=m.sheenRoughnessMap)),m.clearcoat>0&&(p.clearcoat.value=m.clearcoat,p.clearcoatRoughness.value=m.clearcoatRoughness,m.clearcoatMap&&(p.clearcoatMap.value=m.clearcoatMap),m.clearcoatRoughnessMap&&(p.clearcoatRoughnessMap.value=m.clearcoatRoughnessMap),m.clearcoatNormalMap&&(p.clearcoatNormalScale.value.copy(m.clearcoatNormalScale),p.clearcoatNormalMap.value=m.clearcoatNormalMap,m.side===Ft&&p.clearcoatNormalScale.value.negate())),m.iridescence>0&&(p.iridescence.value=m.iridescence,p.iridescenceIOR.value=m.iridescenceIOR,p.iridescenceThicknessMinimum.value=m.iridescenceThicknessRange[0],p.iridescenceThicknessMaximum.value=m.iridescenceThicknessRange[1],m.iridescenceMap&&(p.iridescenceMap.value=m.iridescenceMap),m.iridescenceThicknessMap&&(p.iridescenceThicknessMap.value=m.iridescenceThicknessMap)),m.transmission>0&&(p.transmission.value=m.transmission,p.transmissionSamplerMap.value=v.texture,p.transmissionSamplerSize.value.set(v.width,v.height),m.transmissionMap&&(p.transmissionMap.value=m.transmissionMap),p.thickness.value=m.thickness,m.thicknessMap&&(p.thicknessMap.value=m.thicknessMap),p.attenuationDistance.value=m.attenuationDistance,p.attenuationColor.value.copy(m.attenuationColor)),p.specularIntensity.value=m.specularIntensity,p.specularColor.value.copy(m.specularColor),m.specularIntensityMap&&(p.specularIntensityMap.value=m.specularIntensityMap),m.specularColorMap&&(p.specularColorMap.value=m.specularColorMap)}function d(p,m){m.matcap&&(p.matcap.value=m.matcap)}function g(p,m){p.referencePosition.value.copy(m.referencePosition),p.nearDistance.value=m.nearDistance,p.farDistance.value=m.farDistance}return{refreshFogUniforms:t,refreshMaterialUniforms:i}}function Xy(n,e,t,i){let r={},s={},a=[];const o=t.isWebGL2?n.getParameter(35375):0;function l(b,_){const S=_.program;i.uniformBlockBinding(b,S)}function c(b,_){let S=r[b.id];S===void 0&&(g(b),S=u(b),r[b.id]=S,b.addEventListener("dispose",m));const E=_.program;i.updateUBOMapping(b,E);const L=e.render.frame;s[b.id]!==L&&(h(b),s[b.id]=L)}function u(b){const _=f();b.__bindingPointIndex=_;const S=n.createBuffer(),E=b.__size,L=b.usage;return n.bindBuffer(35345,S),n.bufferData(35345,E,L),n.bindBuffer(35345,null),n.bindBufferBase(35345,_,S),S}function f(){for(let b=0;b<o;b++)if(a.indexOf(b)===-1)return a.push(b),b;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function h(b){const _=r[b.id],S=b.uniforms,E=b.__cache;n.bindBuffer(35345,_);for(let L=0,O=S.length;L<O;L++){const M=S[L];if(d(M,L,E)===!0){const P=M.__offset,U=Array.isArray(M.value)?M.value:[M.value];let J=0;for(let ce=0;ce<U.length;ce++){const V=U[ce],z=p(V);typeof V=="number"?(M.__data[0]=V,n.bufferSubData(35345,P+J,M.__data)):V.isMatrix3?(M.__data[0]=V.elements[0],M.__data[1]=V.elements[1],M.__data[2]=V.elements[2],M.__data[3]=V.elements[0],M.__data[4]=V.elements[3],M.__data[5]=V.elements[4],M.__data[6]=V.elements[5],M.__data[7]=V.elements[0],M.__data[8]=V.elements[6],M.__data[9]=V.elements[7],M.__data[10]=V.elements[8],M.__data[11]=V.elements[0]):(V.toArray(M.__data,J),J+=z.storage/Float32Array.BYTES_PER_ELEMENT)}n.bufferSubData(35345,P,M.__data)}}n.bindBuffer(35345,null)}function d(b,_,S){const E=b.value;if(S[_]===void 0){if(typeof E=="number")S[_]=E;else{const L=Array.isArray(E)?E:[E],O=[];for(let M=0;M<L.length;M++)O.push(L[M].clone());S[_]=O}return!0}else if(typeof E=="number"){if(S[_]!==E)return S[_]=E,!0}else{const L=Array.isArray(S[_])?S[_]:[S[_]],O=Array.isArray(E)?E:[E];for(let M=0;M<L.length;M++){const P=L[M];if(P.equals(O[M])===!1)return P.copy(O[M]),!0}}return!1}function g(b){const _=b.uniforms;let S=0;const E=16;let L=0;for(let O=0,M=_.length;O<M;O++){const P=_[O],U={boundary:0,storage:0},J=Array.isArray(P.value)?P.value:[P.value];for(let ce=0,V=J.length;ce<V;ce++){const z=J[ce],Z=p(z);U.boundary+=Z.boundary,U.storage+=Z.storage}if(P.__data=new Float32Array(U.storage/Float32Array.BYTES_PER_ELEMENT),P.__offset=S,O>0){L=S%E;const ce=E-L;L!==0&&ce-U.boundary<0&&(S+=E-L,P.__offset=S)}S+=U.storage}return L=S%E,L>0&&(S+=E-L),b.__size=S,b.__cache={},this}function p(b){const _={boundary:0,storage:0};return typeof b=="number"?(_.boundary=4,_.storage=4):b.isVector2?(_.boundary=8,_.storage=8):b.isVector3||b.isColor?(_.boundary=16,_.storage=12):b.isVector4?(_.boundary=16,_.storage=16):b.isMatrix3?(_.boundary=48,_.storage=48):b.isMatrix4?(_.boundary=64,_.storage=64):b.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",b),_}function m(b){const _=b.target;_.removeEventListener("dispose",m);const S=a.indexOf(_.__bindingPointIndex);a.splice(S,1),n.deleteBuffer(r[_.id]),delete r[_.id],delete s[_.id]}function v(){for(const b in r)n.deleteBuffer(r[b]);a=[],r={},s={}}return{bind:l,update:c,dispose:v}}function qy(){const n=Wr("canvas");return n.style.display="block",n}function qa(n={}){this.isWebGLRenderer=!0;const e=n.canvas!==void 0?n.canvas:qy(),t=n.context!==void 0?n.context:null,i=n.depth!==void 0?n.depth:!0,r=n.stencil!==void 0?n.stencil:!0,s=n.antialias!==void 0?n.antialias:!1,a=n.premultipliedAlpha!==void 0?n.premultipliedAlpha:!0,o=n.preserveDrawingBuffer!==void 0?n.preserveDrawingBuffer:!1,l=n.powerPreference!==void 0?n.powerPreference:"default",c=n.failIfMajorPerformanceCaveat!==void 0?n.failIfMajorPerformanceCaveat:!1;let u;t!==null?u=t.getContextAttributes().alpha:u=n.alpha!==void 0?n.alpha:!1;let f=null,h=null;const d=[],g=[];this.domElement=e,this.debug={checkShaderErrors:!0},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.outputEncoding=yi,this.useLegacyLights=!0,this.toneMapping=In,this.toneMappingExposure=1;const p=this;let m=!1,v=0,b=0,_=null,S=-1,E=null;const L=new _t,O=new _t;let M=null,P=e.width,U=e.height,J=1,ce=null,V=null;const z=new _t(0,0,P,U),Z=new _t(0,0,P,U);let re=!1;const se=new Qf;let W=!1,ae=!1,he=null;const we=new lt,j=new N,fe={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};function _e(){return _===null?J:1}let k=t;function be(T,H){for(let Q=0;Q<T.length;Q++){const G=T[Q],ie=e.getContext(G,H);if(ie!==null)return ie}return null}try{const T={alpha:!0,depth:i,stencil:r,antialias:s,premultipliedAlpha:a,preserveDrawingBuffer:o,powerPreference:l,failIfMajorPerformanceCaveat:c};if("setAttribute"in e&&e.setAttribute("data-engine",`three.js r${ka}`),e.addEventListener("webglcontextlost",Me,!1),e.addEventListener("webglcontextrestored",Ae,!1),e.addEventListener("webglcontextcreationerror",Ce,!1),k===null){const H=["webgl2","webgl","experimental-webgl"];if(p.isWebGL1Renderer===!0&&H.shift(),k=be(H,T),k===null)throw be(H)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}k.getShaderPrecisionFormat===void 0&&(k.getShaderPrecisionFormat=function(){return{rangeMin:1,rangeMax:1,precision:1}})}catch(T){throw console.error("THREE.WebGLRenderer: "+T.message),T}let I,K,q,oe,Se,Te,w,C,B,ne,Y,ee,ue,pe,de,y,x,R,X,$,le,xe,A,F;function ve(){I=new rx(k),K=new Kv(k,I,n),I.init(K),xe=new Gy(k,I,K),q=new zy(k,I,K),oe=new ax,Se=new wy,Te=new By(k,I,q,Se,K,xe,oe),w=new Qv(p),C=new ix(p),B=new m_(k,K),A=new Zv(k,I,B,K),ne=new sx(k,B,oe,A),Y=new fx(k,ne,B,oe),X=new ux(k,K,Te),y=new Jv(Se),ee=new Sy(p,w,C,I,K,A,y),ue=new jy(p,Se),pe=new Ty,de=new Dy(I,K),R=new Yv(p,w,C,q,Y,u,a),x=new Uy(p,Y,K),F=new Xy(k,oe,K,q),$=new $v(k,I,oe,K),le=new ox(k,I,oe,K),oe.programs=ee.programs,p.capabilities=K,p.extensions=I,p.properties=Se,p.renderLists=pe,p.shadowMap=x,p.state=q,p.info=oe}ve();const ge=new Wy(p,k);this.xr=ge,this.getContext=function(){return k},this.getContextAttributes=function(){return k.getContextAttributes()},this.forceContextLoss=function(){const T=I.get("WEBGL_lose_context");T&&T.loseContext()},this.forceContextRestore=function(){const T=I.get("WEBGL_lose_context");T&&T.restoreContext()},this.getPixelRatio=function(){return J},this.setPixelRatio=function(T){T!==void 0&&(J=T,this.setSize(P,U,!1))},this.getSize=function(T){return T.set(P,U)},this.setSize=function(T,H,Q=!0){if(ge.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}P=T,U=H,e.width=Math.floor(T*J),e.height=Math.floor(H*J),Q===!0&&(e.style.width=T+"px",e.style.height=H+"px"),this.setViewport(0,0,T,H)},this.getDrawingBufferSize=function(T){return T.set(P*J,U*J).floor()},this.setDrawingBufferSize=function(T,H,Q){P=T,U=H,J=Q,e.width=Math.floor(T*Q),e.height=Math.floor(H*Q),this.setViewport(0,0,T,H)},this.getCurrentViewport=function(T){return T.copy(L)},this.getViewport=function(T){return T.copy(z)},this.setViewport=function(T,H,Q,G){T.isVector4?z.set(T.x,T.y,T.z,T.w):z.set(T,H,Q,G),q.viewport(L.copy(z).multiplyScalar(J).floor())},this.getScissor=function(T){return T.copy(Z)},this.setScissor=function(T,H,Q,G){T.isVector4?Z.set(T.x,T.y,T.z,T.w):Z.set(T,H,Q,G),q.scissor(O.copy(Z).multiplyScalar(J).floor())},this.getScissorTest=function(){return re},this.setScissorTest=function(T){q.setScissorTest(re=T)},this.setOpaqueSort=function(T){ce=T},this.setTransparentSort=function(T){V=T},this.getClearColor=function(T){return T.copy(R.getClearColor())},this.setClearColor=function(){R.setClearColor.apply(R,arguments)},this.getClearAlpha=function(){return R.getClearAlpha()},this.setClearAlpha=function(){R.setClearAlpha.apply(R,arguments)},this.clear=function(T=!0,H=!0,Q=!0){let G=0;T&&(G|=16384),H&&(G|=256),Q&&(G|=1024),k.clear(G)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){e.removeEventListener("webglcontextlost",Me,!1),e.removeEventListener("webglcontextrestored",Ae,!1),e.removeEventListener("webglcontextcreationerror",Ce,!1),pe.dispose(),de.dispose(),Se.dispose(),w.dispose(),C.dispose(),Y.dispose(),A.dispose(),F.dispose(),ee.dispose(),ge.dispose(),ge.removeEventListener("sessionstart",me),ge.removeEventListener("sessionend",Ee),he&&(he.dispose(),he=null),Pe.stop()};function Me(T){T.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),m=!0}function Ae(){console.log("THREE.WebGLRenderer: Context Restored."),m=!1;const T=oe.autoReset,H=x.enabled,Q=x.autoUpdate,G=x.needsUpdate,ie=x.type;ve(),oe.autoReset=T,x.enabled=H,x.autoUpdate=Q,x.needsUpdate=G,x.type=ie}function Ce(T){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",T.statusMessage)}function Re(T){const H=T.target;H.removeEventListener("dispose",Re),De(H)}function De(T){je(T),Se.remove(T)}function je(T){const H=Se.get(T).programs;H!==void 0&&(H.forEach(function(Q){ee.releaseProgram(Q)}),T.isShaderMaterial&&ee.releaseShaderCache(T))}this.renderBufferDirect=function(T,H,Q,G,ie,Le){H===null&&(H=fe);const Oe=ie.isMesh&&ie.matrixWorld.determinant()<0,ze=fh(T,H,Q,G,ie);q.setMaterial(G,Oe);let Be=Q.index,We=1;G.wireframe===!0&&(Be=ne.getWireframeAttribute(Q),We=2);const ke=Q.drawRange,Ve=Q.attributes.position;let st=ke.start*We,Ut=(ke.start+ke.count)*We;Le!==null&&(st=Math.max(st,Le.start*We),Ut=Math.min(Ut,(Le.start+Le.count)*We)),Be!==null?(st=Math.max(st,0),Ut=Math.min(Ut,Be.count)):Ve!=null&&(st=Math.max(st,0),Ut=Math.min(Ut,Ve.count));const Mn=Ut-st;if(Mn<0||Mn===1/0)return;A.setup(ie,G,ze,Q,Be);let Qn,ot=$;if(Be!==null&&(Qn=B.get(Be),ot=le,ot.setIndex(Qn)),ie.isMesh)G.wireframe===!0?(q.setLineWidth(G.wireframeLinewidth*_e()),ot.setMode(1)):ot.setMode(4);else if(ie.isLine){let He=G.linewidth;He===void 0&&(He=1),q.setLineWidth(He*_e()),ie.isLineSegments?ot.setMode(1):ie.isLineLoop?ot.setMode(2):ot.setMode(3)}else ie.isPoints?ot.setMode(0):ie.isSprite&&ot.setMode(4);if(ie.isInstancedMesh)ot.renderInstances(st,Mn,ie.count);else if(Q.isInstancedBufferGeometry){const He=Q._maxInstanceCount!==void 0?Q._maxInstanceCount:1/0,Js=Math.min(Q.instanceCount,He);ot.renderInstances(st,Mn,Js)}else ot.render(st,Mn)},this.compile=function(T,H){function Q(G,ie,Le){G.transparent===!0&&G.side===Wn&&G.forceSinglePass===!1?(G.side=Ft,G.needsUpdate=!0,Xt(G,ie,Le),G.side=Zn,G.needsUpdate=!0,Xt(G,ie,Le),G.side=Wn):Xt(G,ie,Le)}h=de.get(T),h.init(),g.push(h),T.traverseVisible(function(G){G.isLight&&G.layers.test(H.layers)&&(h.pushLight(G),G.castShadow&&h.pushShadow(G))}),h.setupLights(p.useLegacyLights),T.traverse(function(G){const ie=G.material;if(ie)if(Array.isArray(ie))for(let Le=0;Le<ie.length;Le++){const Oe=ie[Le];Q(Oe,T,G)}else Q(ie,T,G)}),g.pop(),h=null};let D=null;function te(T){D&&D(T)}function me(){Pe.stop()}function Ee(){Pe.start()}const Pe=new eh;Pe.setAnimationLoop(te),typeof self<"u"&&Pe.setContext(self),this.setAnimationLoop=function(T){D=T,ge.setAnimationLoop(T),T===null?Pe.stop():Pe.start()},ge.addEventListener("sessionstart",me),ge.addEventListener("sessionend",Ee),this.render=function(T,H){if(H!==void 0&&H.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(m===!0)return;T.matrixWorldAutoUpdate===!0&&T.updateMatrixWorld(),H.parent===null&&H.matrixWorldAutoUpdate===!0&&H.updateMatrixWorld(),ge.enabled===!0&&ge.isPresenting===!0&&(ge.cameraAutoUpdate===!0&&ge.updateCamera(H),H=ge.getCamera()),T.isScene===!0&&T.onBeforeRender(p,T,H,_),h=de.get(T,g.length),h.init(),g.push(h),we.multiplyMatrices(H.projectionMatrix,H.matrixWorldInverse),se.setFromProjectionMatrix(we),ae=this.localClippingEnabled,W=y.init(this.clippingPlanes,ae),f=pe.get(T,d.length),f.init(),d.push(f),Je(T,H,0,p.sortObjects),f.finish(),p.sortObjects===!0&&f.sort(ce,V),W===!0&&y.beginShadows();const Q=h.state.shadowsArray;if(x.render(Q,T,H),W===!0&&y.endShadows(),this.info.autoReset===!0&&this.info.reset(),R.render(f,T),h.setupLights(p.useLegacyLights),H.isArrayCamera){const G=H.cameras;for(let ie=0,Le=G.length;ie<Le;ie++){const Oe=G[ie];ht(f,T,Oe,Oe.viewport)}}else ht(f,T,H);_!==null&&(Te.updateMultisampleRenderTarget(_),Te.updateRenderTargetMipmap(_)),T.isScene===!0&&T.onAfterRender(p,T,H),A.resetDefaultState(),S=-1,E=null,g.pop(),g.length>0?h=g[g.length-1]:h=null,d.pop(),d.length>0?f=d[d.length-1]:f=null};function Je(T,H,Q,G){if(T.visible===!1)return;if(T.layers.test(H.layers)){if(T.isGroup)Q=T.renderOrder;else if(T.isLOD)T.autoUpdate===!0&&T.update(H);else if(T.isLight)h.pushLight(T),T.castShadow&&h.pushShadow(T);else if(T.isSprite){if(!T.frustumCulled||se.intersectsSprite(T)){G&&j.setFromMatrixPosition(T.matrixWorld).applyMatrix4(we);const Oe=Y.update(T),ze=T.material;ze.visible&&f.push(T,Oe,ze,Q,j.z,null)}}else if((T.isMesh||T.isLine||T.isPoints)&&(T.isSkinnedMesh&&T.skeleton.frame!==oe.render.frame&&(T.skeleton.update(),T.skeleton.frame=oe.render.frame),!T.frustumCulled||se.intersectsObject(T))){G&&j.setFromMatrixPosition(T.matrixWorld).applyMatrix4(we);const Oe=Y.update(T),ze=T.material;if(Array.isArray(ze)){const Be=Oe.groups;for(let We=0,ke=Be.length;We<ke;We++){const Ve=Be[We],st=ze[Ve.materialIndex];st&&st.visible&&f.push(T,Oe,st,Q,j.z,Ve)}}else ze.visible&&f.push(T,Oe,ze,Q,j.z,null)}}const Le=T.children;for(let Oe=0,ze=Le.length;Oe<ze;Oe++)Je(Le[Oe],H,Q,G)}function ht(T,H,Q,G){const ie=T.opaque,Le=T.transmissive,Oe=T.transparent;h.setupLightsView(Q),W===!0&&y.setGlobalState(p.clippingPlanes,Q),Le.length>0&&wt(ie,H,Q),G&&q.viewport(L.copy(G)),ie.length>0&&cn(ie,H,Q),Le.length>0&&cn(Le,H,Q),Oe.length>0&&cn(Oe,H,Q),q.buffers.depth.setTest(!0),q.buffers.depth.setMask(!0),q.buffers.color.setMask(!0),q.setPolygonOffset(!1)}function wt(T,H,Q){const G=K.isWebGL2;he===null&&(he=new Mi(1024,1024,{generateMipmaps:!0,type:I.has("EXT_color_buffer_half_float")?Vr:xi,minFilter:kr,samples:G&&s===!0?4:0}));const ie=p.getRenderTarget();p.setRenderTarget(he),p.clear();const Le=p.toneMapping;p.toneMapping=In,cn(T,H,Q),p.toneMapping=Le,Te.updateMultisampleRenderTarget(he),Te.updateRenderTargetMipmap(he),p.setRenderTarget(ie)}function cn(T,H,Q){const G=H.isScene===!0?H.overrideMaterial:null;for(let ie=0,Le=T.length;ie<Le;ie++){const Oe=T[ie],ze=Oe.object,Be=Oe.geometry,We=G===null?Oe.material:G,ke=Oe.group;ze.layers.test(Q.layers)&&nt(ze,H,Q,Be,We,ke)}}function nt(T,H,Q,G,ie,Le){T.onBeforeRender(p,H,Q,G,ie,Le),T.modelViewMatrix.multiplyMatrices(Q.matrixWorldInverse,T.matrixWorld),T.normalMatrix.getNormalMatrix(T.modelViewMatrix),ie.onBeforeRender(p,H,Q,G,T,Le),ie.transparent===!0&&ie.side===Wn&&ie.forceSinglePass===!1?(ie.side=Ft,ie.needsUpdate=!0,p.renderBufferDirect(Q,H,G,ie,T,Le),ie.side=Zn,ie.needsUpdate=!0,p.renderBufferDirect(Q,H,G,ie,T,Le),ie.side=Wn):p.renderBufferDirect(Q,H,G,ie,T,Le),T.onAfterRender(p,H,Q,G,ie,Le)}function Xt(T,H,Q){H.isScene!==!0&&(H=fe);const G=Se.get(T),ie=h.state.lights,Le=h.state.shadowsArray,Oe=ie.state.version,ze=ee.getParameters(T,ie.state,Le,H,Q),Be=ee.getProgramCacheKey(ze);let We=G.programs;G.environment=T.isMeshStandardMaterial?H.environment:null,G.fog=H.fog,G.envMap=(T.isMeshStandardMaterial?C:w).get(T.envMap||G.environment),We===void 0&&(T.addEventListener("dispose",Re),We=new Map,G.programs=We);let ke=We.get(Be);if(ke!==void 0){if(G.currentProgram===ke&&G.lightsStateVersion===Oe)return un(T,ze),ke}else ze.uniforms=ee.getUniforms(T),T.onBuild(Q,ze,p),T.onBeforeCompile(ze,p),ke=ee.acquireProgram(ze,Be),We.set(Be,ke),G.uniforms=ze.uniforms;const Ve=G.uniforms;(!T.isShaderMaterial&&!T.isRawShaderMaterial||T.clipping===!0)&&(Ve.clippingPlanes=y.uniform),un(T,ze),G.needsLights=dh(T),G.lightsStateVersion=Oe,G.needsLights&&(Ve.ambientLightColor.value=ie.state.ambient,Ve.lightProbe.value=ie.state.probe,Ve.directionalLights.value=ie.state.directional,Ve.directionalLightShadows.value=ie.state.directionalShadow,Ve.spotLights.value=ie.state.spot,Ve.spotLightShadows.value=ie.state.spotShadow,Ve.rectAreaLights.value=ie.state.rectArea,Ve.ltc_1.value=ie.state.rectAreaLTC1,Ve.ltc_2.value=ie.state.rectAreaLTC2,Ve.pointLights.value=ie.state.point,Ve.pointLightShadows.value=ie.state.pointShadow,Ve.hemisphereLights.value=ie.state.hemi,Ve.directionalShadowMap.value=ie.state.directionalShadowMap,Ve.directionalShadowMatrix.value=ie.state.directionalShadowMatrix,Ve.spotShadowMap.value=ie.state.spotShadowMap,Ve.spotLightMatrix.value=ie.state.spotLightMatrix,Ve.spotLightMap.value=ie.state.spotLightMap,Ve.pointShadowMap.value=ie.state.pointShadowMap,Ve.pointShadowMatrix.value=ie.state.pointShadowMatrix);const st=ke.getUniforms(),Ut=As.seqWithValue(st.seq,Ve);return G.currentProgram=ke,G.uniformsList=Ut,ke}function un(T,H){const Q=Se.get(T);Q.outputEncoding=H.outputEncoding,Q.instancing=H.instancing,Q.skinning=H.skinning,Q.morphTargets=H.morphTargets,Q.morphNormals=H.morphNormals,Q.morphColors=H.morphColors,Q.morphTargetsCount=H.morphTargetsCount,Q.numClippingPlanes=H.numClippingPlanes,Q.numIntersection=H.numClipIntersection,Q.vertexAlphas=H.vertexAlphas,Q.vertexTangents=H.vertexTangents,Q.toneMapping=H.toneMapping}function fh(T,H,Q,G,ie){H.isScene!==!0&&(H=fe),Te.resetTextureUnits();const Le=H.fog,Oe=G.isMeshStandardMaterial?H.environment:null,ze=_===null?p.outputEncoding:_.isXRRenderTarget===!0?_.texture.encoding:yi,Be=(G.isMeshStandardMaterial?C:w).get(G.envMap||Oe),We=G.vertexColors===!0&&!!Q.attributes.color&&Q.attributes.color.itemSize===4,ke=!!G.normalMap&&!!Q.attributes.tangent,Ve=!!Q.morphAttributes.position,st=!!Q.morphAttributes.normal,Ut=!!Q.morphAttributes.color,Mn=G.toneMapped?p.toneMapping:In,Qn=Q.morphAttributes.position||Q.morphAttributes.normal||Q.morphAttributes.color,ot=Qn!==void 0?Qn.length:0,He=Se.get(G),Js=h.state.lights;if(W===!0&&(ae===!0||T!==E)){const zt=T===E&&G.id===S;y.setState(G,T,zt)}let dt=!1;G.version===He.__version?(He.needsLights&&He.lightsStateVersion!==Js.state.version||He.outputEncoding!==ze||ie.isInstancedMesh&&He.instancing===!1||!ie.isInstancedMesh&&He.instancing===!0||ie.isSkinnedMesh&&He.skinning===!1||!ie.isSkinnedMesh&&He.skinning===!0||He.envMap!==Be||G.fog===!0&&He.fog!==Le||He.numClippingPlanes!==void 0&&(He.numClippingPlanes!==y.numPlanes||He.numIntersection!==y.numIntersection)||He.vertexAlphas!==We||He.vertexTangents!==ke||He.morphTargets!==Ve||He.morphNormals!==st||He.morphColors!==Ut||He.toneMapping!==Mn||K.isWebGL2===!0&&He.morphTargetsCount!==ot)&&(dt=!0):(dt=!0,He.__version=G.version);let ei=He.currentProgram;dt===!0&&(ei=Xt(G,H,ie));let Za=!1,cr=!1,Qs=!1;const Et=ei.getUniforms(),ti=He.uniforms;if(q.useProgram(ei.program)&&(Za=!0,cr=!0,Qs=!0),G.id!==S&&(S=G.id,cr=!0),Za||E!==T){if(Et.setValue(k,"projectionMatrix",T.projectionMatrix),K.logarithmicDepthBuffer&&Et.setValue(k,"logDepthBufFC",2/(Math.log(T.far+1)/Math.LN2)),E!==T&&(E=T,cr=!0,Qs=!0),G.isShaderMaterial||G.isMeshPhongMaterial||G.isMeshToonMaterial||G.isMeshStandardMaterial||G.envMap){const zt=Et.map.cameraPosition;zt!==void 0&&zt.setValue(k,j.setFromMatrixPosition(T.matrixWorld))}(G.isMeshPhongMaterial||G.isMeshToonMaterial||G.isMeshLambertMaterial||G.isMeshBasicMaterial||G.isMeshStandardMaterial||G.isShaderMaterial)&&Et.setValue(k,"isOrthographic",T.isOrthographicCamera===!0),(G.isMeshPhongMaterial||G.isMeshToonMaterial||G.isMeshLambertMaterial||G.isMeshBasicMaterial||G.isMeshStandardMaterial||G.isShaderMaterial||G.isShadowMaterial||ie.isSkinnedMesh)&&Et.setValue(k,"viewMatrix",T.matrixWorldInverse)}if(ie.isSkinnedMesh){Et.setOptional(k,ie,"bindMatrix"),Et.setOptional(k,ie,"bindMatrixInverse");const zt=ie.skeleton;zt&&(K.floatVertexTextures?(zt.boneTexture===null&&zt.computeBoneTexture(),Et.setValue(k,"boneTexture",zt.boneTexture,Te),Et.setValue(k,"boneTextureSize",zt.boneTextureSize)):console.warn("THREE.WebGLRenderer: SkinnedMesh can only be used with WebGL 2. With WebGL 1 OES_texture_float and vertex textures support is required."))}const eo=Q.morphAttributes;if((eo.position!==void 0||eo.normal!==void 0||eo.color!==void 0&&K.isWebGL2===!0)&&X.update(ie,Q,ei),(cr||He.receiveShadow!==ie.receiveShadow)&&(He.receiveShadow=ie.receiveShadow,Et.setValue(k,"receiveShadow",ie.receiveShadow)),G.isMeshGouraudMaterial&&G.envMap!==null&&(ti.envMap.value=Be,ti.flipEnvMap.value=Be.isCubeTexture&&Be.isRenderTargetTexture===!1?-1:1),cr&&(Et.setValue(k,"toneMappingExposure",p.toneMappingExposure),He.needsLights&&hh(ti,Qs),Le&&G.fog===!0&&ue.refreshFogUniforms(ti,Le),ue.refreshMaterialUniforms(ti,G,J,U,he),As.upload(k,He.uniformsList,ti,Te)),G.isShaderMaterial&&G.uniformsNeedUpdate===!0&&(As.upload(k,He.uniformsList,ti,Te),G.uniformsNeedUpdate=!1),G.isSpriteMaterial&&Et.setValue(k,"center",ie.center),Et.setValue(k,"modelViewMatrix",ie.modelViewMatrix),Et.setValue(k,"normalMatrix",ie.normalMatrix),Et.setValue(k,"modelMatrix",ie.matrixWorld),G.isShaderMaterial||G.isRawShaderMaterial){const zt=G.uniformsGroups;for(let to=0,ph=zt.length;to<ph;to++)if(K.isWebGL2){const $a=zt[to];F.update($a,ei),F.bind($a,ei)}else console.warn("THREE.WebGLRenderer: Uniform Buffer Objects can only be used with WebGL 2.")}return ei}function hh(T,H){T.ambientLightColor.needsUpdate=H,T.lightProbe.needsUpdate=H,T.directionalLights.needsUpdate=H,T.directionalLightShadows.needsUpdate=H,T.pointLights.needsUpdate=H,T.pointLightShadows.needsUpdate=H,T.spotLights.needsUpdate=H,T.spotLightShadows.needsUpdate=H,T.rectAreaLights.needsUpdate=H,T.hemisphereLights.needsUpdate=H}function dh(T){return T.isMeshLambertMaterial||T.isMeshToonMaterial||T.isMeshPhongMaterial||T.isMeshStandardMaterial||T.isShadowMaterial||T.isShaderMaterial&&T.lights===!0}this.getActiveCubeFace=function(){return v},this.getActiveMipmapLevel=function(){return b},this.getRenderTarget=function(){return _},this.setRenderTargetTextures=function(T,H,Q){Se.get(T.texture).__webglTexture=H,Se.get(T.depthTexture).__webglTexture=Q;const G=Se.get(T);G.__hasExternalTextures=!0,G.__hasExternalTextures&&(G.__autoAllocateDepthBuffer=Q===void 0,G.__autoAllocateDepthBuffer||I.has("WEBGL_multisampled_render_to_texture")===!0&&(console.warn("THREE.WebGLRenderer: Render-to-texture extension was disabled because an external texture was provided"),G.__useRenderToTexture=!1))},this.setRenderTargetFramebuffer=function(T,H){const Q=Se.get(T);Q.__webglFramebuffer=H,Q.__useDefaultFramebuffer=H===void 0},this.setRenderTarget=function(T,H=0,Q=0){_=T,v=H,b=Q;let G=!0,ie=null,Le=!1,Oe=!1;if(T){const Be=Se.get(T);Be.__useDefaultFramebuffer!==void 0?(q.bindFramebuffer(36160,null),G=!1):Be.__webglFramebuffer===void 0?Te.setupRenderTarget(T):Be.__hasExternalTextures&&Te.rebindTextures(T,Se.get(T.texture).__webglTexture,Se.get(T.depthTexture).__webglTexture);const We=T.texture;(We.isData3DTexture||We.isDataArrayTexture||We.isCompressedArrayTexture)&&(Oe=!0);const ke=Se.get(T).__webglFramebuffer;T.isWebGLCubeRenderTarget?(ie=ke[H],Le=!0):K.isWebGL2&&T.samples>0&&Te.useMultisampledRTT(T)===!1?ie=Se.get(T).__webglMultisampledFramebuffer:ie=ke,L.copy(T.viewport),O.copy(T.scissor),M=T.scissorTest}else L.copy(z).multiplyScalar(J).floor(),O.copy(Z).multiplyScalar(J).floor(),M=re;if(q.bindFramebuffer(36160,ie)&&K.drawBuffers&&G&&q.drawBuffers(T,ie),q.viewport(L),q.scissor(O),q.setScissorTest(M),Le){const Be=Se.get(T.texture);k.framebufferTexture2D(36160,36064,34069+H,Be.__webglTexture,Q)}else if(Oe){const Be=Se.get(T.texture),We=H||0;k.framebufferTextureLayer(36160,36064,Be.__webglTexture,Q||0,We)}S=-1},this.readRenderTargetPixels=function(T,H,Q,G,ie,Le,Oe){if(!(T&&T.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let ze=Se.get(T).__webglFramebuffer;if(T.isWebGLCubeRenderTarget&&Oe!==void 0&&(ze=ze[Oe]),ze){q.bindFramebuffer(36160,ze);try{const Be=T.texture,We=Be.format,ke=Be.type;if(We!==rn&&xe.convert(We)!==k.getParameter(35739)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}const Ve=ke===Vr&&(I.has("EXT_color_buffer_half_float")||K.isWebGL2&&I.has("EXT_color_buffer_float"));if(ke!==xi&&xe.convert(ke)!==k.getParameter(35738)&&!(ke===pi&&(K.isWebGL2||I.has("OES_texture_float")||I.has("WEBGL_color_buffer_float")))&&!Ve){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}H>=0&&H<=T.width-G&&Q>=0&&Q<=T.height-ie&&k.readPixels(H,Q,G,ie,xe.convert(We),xe.convert(ke),Le)}finally{const Be=_!==null?Se.get(_).__webglFramebuffer:null;q.bindFramebuffer(36160,Be)}}},this.copyFramebufferToTexture=function(T,H,Q=0){const G=Math.pow(2,-Q),ie=Math.floor(H.image.width*G),Le=Math.floor(H.image.height*G);Te.setTexture2D(H,0),k.copyTexSubImage2D(3553,Q,0,0,T.x,T.y,ie,Le),q.unbindTexture()},this.copyTextureToTexture=function(T,H,Q,G=0){const ie=H.image.width,Le=H.image.height,Oe=xe.convert(Q.format),ze=xe.convert(Q.type);Te.setTexture2D(Q,0),k.pixelStorei(37440,Q.flipY),k.pixelStorei(37441,Q.premultiplyAlpha),k.pixelStorei(3317,Q.unpackAlignment),H.isDataTexture?k.texSubImage2D(3553,G,T.x,T.y,ie,Le,Oe,ze,H.image.data):H.isCompressedTexture?k.compressedTexSubImage2D(3553,G,T.x,T.y,H.mipmaps[0].width,H.mipmaps[0].height,Oe,H.mipmaps[0].data):k.texSubImage2D(3553,G,T.x,T.y,Oe,ze,H.image),G===0&&Q.generateMipmaps&&k.generateMipmap(3553),q.unbindTexture()},this.copyTextureToTexture3D=function(T,H,Q,G,ie=0){if(p.isWebGL1Renderer){console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: can only be used with WebGL2.");return}const Le=T.max.x-T.min.x+1,Oe=T.max.y-T.min.y+1,ze=T.max.z-T.min.z+1,Be=xe.convert(G.format),We=xe.convert(G.type);let ke;if(G.isData3DTexture)Te.setTexture3D(G,0),ke=32879;else if(G.isDataArrayTexture)Te.setTexture2DArray(G,0),ke=35866;else{console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: only supports THREE.DataTexture3D and THREE.DataTexture2DArray.");return}k.pixelStorei(37440,G.flipY),k.pixelStorei(37441,G.premultiplyAlpha),k.pixelStorei(3317,G.unpackAlignment);const Ve=k.getParameter(3314),st=k.getParameter(32878),Ut=k.getParameter(3316),Mn=k.getParameter(3315),Qn=k.getParameter(32877),ot=Q.isCompressedTexture?Q.mipmaps[0]:Q.image;k.pixelStorei(3314,ot.width),k.pixelStorei(32878,ot.height),k.pixelStorei(3316,T.min.x),k.pixelStorei(3315,T.min.y),k.pixelStorei(32877,T.min.z),Q.isDataTexture||Q.isData3DTexture?k.texSubImage3D(ke,ie,H.x,H.y,H.z,Le,Oe,ze,Be,We,ot.data):Q.isCompressedArrayTexture?(console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: untested support for compressed srcTexture."),k.compressedTexSubImage3D(ke,ie,H.x,H.y,H.z,Le,Oe,ze,Be,ot.data)):k.texSubImage3D(ke,ie,H.x,H.y,H.z,Le,Oe,ze,Be,We,ot),k.pixelStorei(3314,Ve),k.pixelStorei(32878,st),k.pixelStorei(3316,Ut),k.pixelStorei(3315,Mn),k.pixelStorei(32877,Qn),ie===0&&G.generateMipmaps&&k.generateMipmap(ke),q.unbindTexture()},this.initTexture=function(T){T.isCubeTexture?Te.setTextureCube(T,0):T.isData3DTexture?Te.setTexture3D(T,0):T.isDataArrayTexture||T.isCompressedArrayTexture?Te.setTexture2DArray(T,0):Te.setTexture2D(T,0),q.unbindTexture()},this.resetState=function(){v=0,b=0,_=null,q.reset(),A.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}Object.defineProperties(qa.prototype,{physicallyCorrectLights:{get:function(){return console.warn("THREE.WebGLRenderer: the property .physicallyCorrectLights has been removed. Set renderer.useLegacyLights instead."),!this.useLegacyLights},set:function(n){console.warn("THREE.WebGLRenderer: the property .physicallyCorrectLights has been removed. Set renderer.useLegacyLights instead."),this.useLegacyLights=!n}}});class Yy extends qa{}Yy.prototype.isWebGL1Renderer=!0;class Zy extends mt{constructor(){super(),this.isScene=!0,this.type="Scene",this.background=null,this.environment=null,this.fog=null,this.backgroundBlurriness=0,this.backgroundIntensity=1,this.overrideMaterial=null,typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}copy(e,t){return super.copy(e,t),e.background!==null&&(this.background=e.background.clone()),e.environment!==null&&(this.environment=e.environment.clone()),e.fog!==null&&(this.fog=e.fog.clone()),this.backgroundBlurriness=e.backgroundBlurriness,this.backgroundIntensity=e.backgroundIntensity,e.overrideMaterial!==null&&(this.overrideMaterial=e.overrideMaterial.clone()),this.matrixAutoUpdate=e.matrixAutoUpdate,this}toJSON(e){const t=super.toJSON(e);return this.fog!==null&&(t.object.fog=this.fog.toJSON()),this.backgroundBlurriness>0&&(t.object.backgroundBlurriness=this.backgroundBlurriness),this.backgroundIntensity!==1&&(t.object.backgroundIntensity=this.backgroundIntensity),t}get autoUpdate(){return console.warn("THREE.Scene: autoUpdate was renamed to matrixWorldAutoUpdate in r144."),this.matrixWorldAutoUpdate}set autoUpdate(e){console.warn("THREE.Scene: autoUpdate was renamed to matrixWorldAutoUpdate in r144."),this.matrixWorldAutoUpdate=e}}class Ya extends Zr{constructor(e){super(),this.isLineBasicMaterial=!0,this.type="LineBasicMaterial",this.color=new Xe(16777215),this.linewidth=1,this.linecap="round",this.linejoin="round",this.fog=!0,this.setValues(e)}copy(e){return super.copy(e),this.color.copy(e.color),this.linewidth=e.linewidth,this.linecap=e.linecap,this.linejoin=e.linejoin,this.fog=e.fog,this}}const eu=new N,tu=new N,nu=new lt,Zo=new Va,ys=new Ys;class $y extends mt{constructor(e=new ln,t=new Ya){super(),this.isLine=!0,this.type="Line",this.geometry=e,this.material=t,this.updateMorphTargets()}copy(e,t){return super.copy(e,t),this.material=e.material,this.geometry=e.geometry,this}computeLineDistances(){const e=this.geometry;if(e.index===null){const t=e.attributes.position,i=[0];for(let r=1,s=t.count;r<s;r++)eu.fromBufferAttribute(t,r-1),tu.fromBufferAttribute(t,r),i[r]=i[r-1],i[r]+=eu.distanceTo(tu);e.setAttribute("lineDistance",new St(i,1))}else console.warn("THREE.Line.computeLineDistances(): Computation only possible with non-indexed BufferGeometry.");return this}raycast(e,t){const i=this.geometry,r=this.matrixWorld,s=e.params.Line.threshold,a=i.drawRange;if(i.boundingSphere===null&&i.computeBoundingSphere(),ys.copy(i.boundingSphere),ys.applyMatrix4(r),ys.radius+=s,e.ray.intersectsSphere(ys)===!1)return;nu.copy(r).invert(),Zo.copy(e.ray).applyMatrix4(nu);const o=s/((this.scale.x+this.scale.y+this.scale.z)/3),l=o*o,c=new N,u=new N,f=new N,h=new N,d=this.isLineSegments?2:1,g=i.index,m=i.attributes.position;if(g!==null){const v=Math.max(0,a.start),b=Math.min(g.count,a.start+a.count);for(let _=v,S=b-1;_<S;_+=d){const E=g.getX(_),L=g.getX(_+1);if(c.fromBufferAttribute(m,E),u.fromBufferAttribute(m,L),Zo.distanceSqToSegment(c,u,h,f)>l)continue;h.applyMatrix4(this.matrixWorld);const M=e.ray.origin.distanceTo(h);M<e.near||M>e.far||t.push({distance:M,point:f.clone().applyMatrix4(this.matrixWorld),index:_,face:null,faceIndex:null,object:this})}}else{const v=Math.max(0,a.start),b=Math.min(m.count,a.start+a.count);for(let _=v,S=b-1;_<S;_+=d){if(c.fromBufferAttribute(m,_),u.fromBufferAttribute(m,_+1),Zo.distanceSqToSegment(c,u,h,f)>l)continue;h.applyMatrix4(this.matrixWorld);const L=e.ray.origin.distanceTo(h);L<e.near||L>e.far||t.push({distance:L,point:f.clone().applyMatrix4(this.matrixWorld),index:_,face:null,faceIndex:null,object:this})}}}updateMorphTargets(){const t=this.geometry.morphAttributes,i=Object.keys(t);if(i.length>0){const r=t[i[0]];if(r!==void 0){this.morphTargetInfluences=[],this.morphTargetDictionary={};for(let s=0,a=r.length;s<a;s++){const o=r[s].name||String(s);this.morphTargetInfluences.push(0),this.morphTargetDictionary[o]=s}}}}}const iu=new N,ru=new N;class sh extends $y{constructor(e,t){super(e,t),this.isLineSegments=!0,this.type="LineSegments"}computeLineDistances(){const e=this.geometry;if(e.index===null){const t=e.attributes.position,i=[];for(let r=0,s=t.count;r<s;r+=2)iu.fromBufferAttribute(t,r),ru.fromBufferAttribute(t,r+1),i[r]=r===0?0:i[r-1],i[r+1]=i[r]+iu.distanceTo(ru);e.setAttribute("lineDistance",new St(i,1))}else console.warn("THREE.LineSegments.computeLineDistances(): Computation only possible with non-indexed BufferGeometry.");return this}}class Ks extends ln{constructor(e=1,t=32,i=16,r=0,s=Math.PI*2,a=0,o=Math.PI){super(),this.type="SphereGeometry",this.parameters={radius:e,widthSegments:t,heightSegments:i,phiStart:r,phiLength:s,thetaStart:a,thetaLength:o},t=Math.max(3,Math.floor(t)),i=Math.max(2,Math.floor(i));const l=Math.min(a+o,Math.PI);let c=0;const u=[],f=new N,h=new N,d=[],g=[],p=[],m=[];for(let v=0;v<=i;v++){const b=[],_=v/i;let S=0;v==0&&a==0?S=.5/t:v==i&&l==Math.PI&&(S=-.5/t);for(let E=0;E<=t;E++){const L=E/t;f.x=-e*Math.cos(r+L*s)*Math.sin(a+_*o),f.y=e*Math.cos(a+_*o),f.z=e*Math.sin(r+L*s)*Math.sin(a+_*o),g.push(f.x,f.y,f.z),h.copy(f).normalize(),p.push(h.x,h.y,h.z),m.push(L+S,1-_),b.push(c++)}u.push(b)}for(let v=0;v<i;v++)for(let b=0;b<t;b++){const _=u[v][b+1],S=u[v][b],E=u[v+1][b],L=u[v+1][b+1];(v!==0||a>0)&&d.push(_,S,L),(v!==i-1||l<Math.PI)&&d.push(S,E,L)}this.setIndex(d),this.setAttribute("position",new St(g,3)),this.setAttribute("normal",new St(p,3)),this.setAttribute("uv",new St(m,2))}copy(e){return super.copy(e),this.parameters=Object.assign({},e.parameters),this}static fromJSON(e){return new Ks(e.radius,e.widthSegments,e.heightSegments,e.phiStart,e.phiLength,e.thetaStart,e.thetaLength)}}class oh extends $n{constructor(e){super(e),this.isRawShaderMaterial=!0,this.type="RawShaderMaterial"}}const su={enabled:!1,files:{},add:function(n,e){this.enabled!==!1&&(this.files[n]=e)},get:function(n){if(this.enabled!==!1)return this.files[n]},remove:function(n){delete this.files[n]},clear:function(){this.files={}}};class Ky{constructor(e,t,i){const r=this;let s=!1,a=0,o=0,l;const c=[];this.onStart=void 0,this.onLoad=e,this.onProgress=t,this.onError=i,this.itemStart=function(u){o++,s===!1&&r.onStart!==void 0&&r.onStart(u,a,o),s=!0},this.itemEnd=function(u){a++,r.onProgress!==void 0&&r.onProgress(u,a,o),a===o&&(s=!1,r.onLoad!==void 0&&r.onLoad())},this.itemError=function(u){r.onError!==void 0&&r.onError(u)},this.resolveURL=function(u){return l?l(u):u},this.setURLModifier=function(u){return l=u,this},this.addHandler=function(u,f){return c.push(u,f),this},this.removeHandler=function(u){const f=c.indexOf(u);return f!==-1&&c.splice(f,2),this},this.getHandler=function(u){for(let f=0,h=c.length;f<h;f+=2){const d=c[f],g=c[f+1];if(d.global&&(d.lastIndex=0),d.test(u))return g}return null}}}const Jy=new Ky;class ah{constructor(e){this.manager=e!==void 0?e:Jy,this.crossOrigin="anonymous",this.withCredentials=!1,this.path="",this.resourcePath="",this.requestHeader={}}load(){}loadAsync(e,t){const i=this;return new Promise(function(r,s){i.load(e,r,t,s)})}parse(){}setCrossOrigin(e){return this.crossOrigin=e,this}setWithCredentials(e){return this.withCredentials=e,this}setPath(e){return this.path=e,this}setResourcePath(e){return this.resourcePath=e,this}setRequestHeader(e){return this.requestHeader=e,this}}class Qy extends ah{constructor(e){super(e)}load(e,t,i,r){this.path!==void 0&&(e=this.path+e),e=this.manager.resolveURL(e);const s=this,a=su.get(e);if(a!==void 0)return s.manager.itemStart(e),setTimeout(function(){t&&t(a),s.manager.itemEnd(e)},0),a;const o=Wr("img");function l(){u(),su.add(e,this),t&&t(this),s.manager.itemEnd(e)}function c(f){u(),r&&r(f),s.manager.itemError(e),s.manager.itemEnd(e)}function u(){o.removeEventListener("load",l,!1),o.removeEventListener("error",c,!1)}return o.addEventListener("load",l,!1),o.addEventListener("error",c,!1),e.slice(0,5)!=="data:"&&this.crossOrigin!==void 0&&(o.crossOrigin=this.crossOrigin),s.manager.itemStart(e),o.src=e,o}}class ai extends ah{constructor(e){super(e)}load(e,t,i,r){const s=new Nt,a=new Qy(this.manager);return a.setCrossOrigin(this.crossOrigin),a.setPath(this.path),a.load(e,function(o){s.image=o,s.needsUpdate=!0,t!==void 0&&t(s)},i,r),s}}class eb{constructor(e,t,i=0,r=1/0){this.ray=new Va(e,t),this.near=i,this.far=r,this.camera=null,this.layers=new Ha,this.params={Mesh:{},Line:{threshold:1},LOD:{},Points:{threshold:1},Sprite:{}}}set(e,t){this.ray.set(e,t)}setFromCamera(e,t){t.isPerspectiveCamera?(this.ray.origin.setFromMatrixPosition(t.matrixWorld),this.ray.direction.set(e.x,e.y,.5).unproject(t).sub(this.ray.origin).normalize(),this.camera=t):t.isOrthographicCamera?(this.ray.origin.set(e.x,e.y,(t.near+t.far)/(t.near-t.far)).unproject(t),this.ray.direction.set(0,0,-1).transformDirection(t.matrixWorld),this.camera=t):console.error("THREE.Raycaster: Unsupported camera type: "+t.type)}intersectObject(e,t=!0,i=[]){return ya(e,this,i,t),i.sort(ou),i}intersectObjects(e,t=!0,i=[]){for(let r=0,s=e.length;r<s;r++)ya(e[r],this,i,t);return i.sort(ou),i}}function ou(n,e){return n.distance-e.distance}function ya(n,e,t,i){if(n.layers.test(e.layers)&&n.raycast(e,t),i===!0){const r=n.children;for(let s=0,a=r.length;s<a;s++)ya(r[s],e,t,!0)}}class au{constructor(e=1,t=0,i=0){return this.radius=e,this.phi=t,this.theta=i,this}set(e,t,i){return this.radius=e,this.phi=t,this.theta=i,this}copy(e){return this.radius=e.radius,this.phi=e.phi,this.theta=e.theta,this}makeSafe(){return this.phi=Math.max(1e-6,Math.min(Math.PI-1e-6,this.phi)),this}setFromVector3(e){return this.setFromCartesianCoords(e.x,e.y,e.z)}setFromCartesianCoords(e,t,i){return this.radius=Math.sqrt(e*e+t*t+i*i),this.radius===0?(this.theta=0,this.phi=0):(this.theta=Math.atan2(e,i),this.phi=Math.acos(Ot(t/this.radius,-1,1))),this}clone(){return new this.constructor().copy(this)}}const bs=new N,et=new Wa;class tb extends sh{constructor(e){const t=new ln,i=new Ya({color:16777215,vertexColors:!0,toneMapped:!1}),r=[],s=[],a={};o("n1","n2"),o("n2","n4"),o("n4","n3"),o("n3","n1"),o("f1","f2"),o("f2","f4"),o("f4","f3"),o("f3","f1"),o("n1","f1"),o("n2","f2"),o("n3","f3"),o("n4","f4"),o("p","n1"),o("p","n2"),o("p","n3"),o("p","n4"),o("u1","u2"),o("u2","u3"),o("u3","u1"),o("c","t"),o("p","c"),o("cn1","cn2"),o("cn3","cn4"),o("cf1","cf2"),o("cf3","cf4");function o(g,p){l(g),l(p)}function l(g){r.push(0,0,0),s.push(0,0,0),a[g]===void 0&&(a[g]=[]),a[g].push(r.length/3-1)}t.setAttribute("position",new St(r,3)),t.setAttribute("color",new St(s,3)),super(t,i),this.type="CameraHelper",this.camera=e,this.camera.updateProjectionMatrix&&this.camera.updateProjectionMatrix(),this.matrix=e.matrixWorld,this.matrixAutoUpdate=!1,this.pointMap=a,this.update();const c=new Xe(16755200),u=new Xe(16711680),f=new Xe(43775),h=new Xe(16777215),d=new Xe(3355443);this.setColors(c,u,f,h,d)}setColors(e,t,i,r,s){const o=this.geometry.getAttribute("color");o.setXYZ(0,e.r,e.g,e.b),o.setXYZ(1,e.r,e.g,e.b),o.setXYZ(2,e.r,e.g,e.b),o.setXYZ(3,e.r,e.g,e.b),o.setXYZ(4,e.r,e.g,e.b),o.setXYZ(5,e.r,e.g,e.b),o.setXYZ(6,e.r,e.g,e.b),o.setXYZ(7,e.r,e.g,e.b),o.setXYZ(8,e.r,e.g,e.b),o.setXYZ(9,e.r,e.g,e.b),o.setXYZ(10,e.r,e.g,e.b),o.setXYZ(11,e.r,e.g,e.b),o.setXYZ(12,e.r,e.g,e.b),o.setXYZ(13,e.r,e.g,e.b),o.setXYZ(14,e.r,e.g,e.b),o.setXYZ(15,e.r,e.g,e.b),o.setXYZ(16,e.r,e.g,e.b),o.setXYZ(17,e.r,e.g,e.b),o.setXYZ(18,e.r,e.g,e.b),o.setXYZ(19,e.r,e.g,e.b),o.setXYZ(20,e.r,e.g,e.b),o.setXYZ(21,e.r,e.g,e.b),o.setXYZ(22,e.r,e.g,e.b),o.setXYZ(23,e.r,e.g,e.b),o.setXYZ(24,t.r,t.g,t.b),o.setXYZ(25,t.r,t.g,t.b),o.setXYZ(26,t.r,t.g,t.b),o.setXYZ(27,t.r,t.g,t.b),o.setXYZ(28,t.r,t.g,t.b),o.setXYZ(29,t.r,t.g,t.b),o.setXYZ(30,t.r,t.g,t.b),o.setXYZ(31,t.r,t.g,t.b),o.setXYZ(32,i.r,i.g,i.b),o.setXYZ(33,i.r,i.g,i.b),o.setXYZ(34,i.r,i.g,i.b),o.setXYZ(35,i.r,i.g,i.b),o.setXYZ(36,i.r,i.g,i.b),o.setXYZ(37,i.r,i.g,i.b),o.setXYZ(38,r.r,r.g,r.b),o.setXYZ(39,r.r,r.g,r.b),o.setXYZ(40,s.r,s.g,s.b),o.setXYZ(41,s.r,s.g,s.b),o.setXYZ(42,s.r,s.g,s.b),o.setXYZ(43,s.r,s.g,s.b),o.setXYZ(44,s.r,s.g,s.b),o.setXYZ(45,s.r,s.g,s.b),o.setXYZ(46,s.r,s.g,s.b),o.setXYZ(47,s.r,s.g,s.b),o.setXYZ(48,s.r,s.g,s.b),o.setXYZ(49,s.r,s.g,s.b),o.needsUpdate=!0}update(){const e=this.geometry,t=this.pointMap,i=1,r=1;et.projectionMatrixInverse.copy(this.camera.projectionMatrixInverse),it("c",t,e,et,0,0,-1),it("t",t,e,et,0,0,1),it("n1",t,e,et,-i,-r,-1),it("n2",t,e,et,i,-r,-1),it("n3",t,e,et,-i,r,-1),it("n4",t,e,et,i,r,-1),it("f1",t,e,et,-i,-r,1),it("f2",t,e,et,i,-r,1),it("f3",t,e,et,-i,r,1),it("f4",t,e,et,i,r,1),it("u1",t,e,et,i*.7,r*1.1,-1),it("u2",t,e,et,-i*.7,r*1.1,-1),it("u3",t,e,et,0,r*2,-1),it("cf1",t,e,et,-i,0,1),it("cf2",t,e,et,i,0,1),it("cf3",t,e,et,0,-r,1),it("cf4",t,e,et,0,r,1),it("cn1",t,e,et,-i,0,-1),it("cn2",t,e,et,i,0,-1),it("cn3",t,e,et,0,-r,-1),it("cn4",t,e,et,0,r,-1),e.getAttribute("position").needsUpdate=!0}dispose(){this.geometry.dispose(),this.material.dispose()}}function it(n,e,t,i,r,s,a){bs.set(r,s,a).unproject(i);const o=e[n];if(o!==void 0){const l=t.getAttribute("position");for(let c=0,u=o.length;c<u;c++)l.setXYZ(o[c],bs.x,bs.y,bs.z)}}class nb extends sh{constructor(e=1){const t=[0,0,0,e,0,0,0,0,0,0,e,0,0,0,0,0,0,e],i=[1,0,0,1,.6,0,0,1,0,.6,1,0,0,0,1,0,.6,1],r=new ln;r.setAttribute("position",new St(t,3)),r.setAttribute("color",new St(i,3));const s=new Ya({vertexColors:!0,toneMapped:!1});super(r,s),this.type="AxesHelper"}setColors(e,t,i){const r=new Xe,s=this.geometry.attributes.color.array;return r.set(e),r.toArray(s,0),r.toArray(s,3),r.set(t),r.toArray(s,6),r.toArray(s,9),r.set(i),r.toArray(s,12),r.toArray(s,15),this.geometry.attributes.color.needsUpdate=!0,this}dispose(){this.geometry.dispose(),this.material.dispose()}}typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("register",{detail:{revision:ka}}));typeof window<"u"&&(window.__THREE__?console.warn("WARNING: Multiple instances of Three.js being imported."):window.__THREE__=ka);var lu=class{constructor(n,e){Ie(this,"target");Ie(this,"name");Ie(this,"intersected");Ie(this,"wasIntersected",!1);Ie(this,"wasIntersectedOnMouseDown",!1);Ie(this,"distance");this.target=n,this.name=e,this.intersected=!1,this.distance=0}},It=class{constructor(n,e=null){Ie(this,"type");Ie(this,"cancelBubble");Ie(this,"originalEvent");Ie(this,"coords",new Ge(0,0));Ie(this,"distance",0);Ie(this,"intersected",!1);Ie(this,"wasIntersected",!1);Ie(this,"wasIntersectedOnMouseDown",!1);this.cancelBubble=!1,this.type=n,this.originalEvent=e}stopPropagation(){this.cancelBubble=!0}},ib=class{constructor(n,e,t,i){Ie(this,"renderer");Ie(this,"camera");Ie(this,"domElement");Ie(this,"bindEventsOnBodyElement");Ie(this,"autoAdd");Ie(this,"scene");Ie(this,"mouse");Ie(this,"supportsPointerEvents");Ie(this,"interactiveObjects");Ie(this,"closestObject");Ie(this,"raycaster");Ie(this,"treatTouchEventsAsMouseEvents");Ie(this,"dispose",()=>{this.domElement.removeEventListener("click",this.onMouseClick),this.supportsPointerEvents&&(this.bindEventsOnBodyElement?this.domElement.ownerDocument.removeEventListener("pointermove",this.onDocumentPointerMove):this.domElement.removeEventListener("pointermove",this.onDocumentPointerMove),this.domElement.removeEventListener("pointerdown",this.onPointerDown),this.domElement.removeEventListener("pointerup",this.onPointerUp)),this.bindEventsOnBodyElement?this.domElement.ownerDocument.removeEventListener("mousemove",this.onDocumentMouseMove):this.domElement.removeEventListener("mousemove",this.onDocumentMouseMove),this.domElement.removeEventListener("mousedown",this.onMouseDown),this.domElement.removeEventListener("mouseup",this.onMouseUp),this.domElement.removeEventListener("touchstart",this.onTouchStart),this.domElement.removeEventListener("touchmove",this.onTouchMove),this.domElement.removeEventListener("touchend",this.onTouchEnd)});Ie(this,"add",(n,e=[])=>{if(n&&!this.interactiveObjects.find(t=>t.target===n))if(e.length>0)e.forEach(t=>{let i=n.getObjectByName(t);if(i){let r=new lu(i,t);this.interactiveObjects.push(r)}});else{let t=new lu(n,n.name);this.interactiveObjects.push(t)}});Ie(this,"remove",(n,e=[])=>{!n||(e.length>0?e.forEach(t=>{let i=n.getObjectByName(t);i&&(this.interactiveObjects=this.interactiveObjects.filter(r=>r.target!==i))}):this.interactiveObjects=this.interactiveObjects.filter(t=>t.target!==n))});Ie(this,"update",()=>{this.raycaster.setFromCamera(this.mouse,this.camera),this.interactiveObjects.forEach(i=>{i.target&&this.checkIntersection(i)}),this.interactiveObjects.sort(function(i,r){return i.distance-r.distance});let n=this.interactiveObjects.find(i=>i.intersected)??null;if(n!=this.closestObject){if(this.closestObject){let i=new It("mouseout");this.dispatch(this.closestObject,i)}if(n){let i=new It("mouseover");this.dispatch(n,i)}this.closestObject=n}let e;this.interactiveObjects.forEach(i=>{!i.intersected&&i.wasIntersected&&(e||(e=new It("mouseleave")),this.dispatch(i,e))});let t;this.interactiveObjects.forEach(i=>{i.intersected&&!i.wasIntersected&&(t||(t=new It("mouseenter")),this.dispatch(i,t))})});Ie(this,"checkIntersection",n=>{let e=this.raycaster.intersectObjects([n.target],!0);if(n.wasIntersected=n.intersected,e.length>0){let t=e[0].distance;e.forEach(i=>{i.distance<t&&(t=i.distance)}),n.intersected=!0,n.distance=t}else n.intersected=!1});Ie(this,"onDocumentMouseMove",n=>{this.mapPositionToPoint(this.mouse,n.clientX,n.clientY);let e=new It("mousemove",n);this.interactiveObjects.forEach(t=>{this.dispatch(t,e)})});Ie(this,"onDocumentPointerMove",n=>{this.mapPositionToPoint(this.mouse,n.clientX,n.clientY);let e=new It("pointermove",n);this.interactiveObjects.forEach(t=>{this.dispatch(t,e)})});Ie(this,"onTouchMove",n=>{n.touches.length>0&&this.mapPositionToPoint(this.mouse,n.touches[0].clientX,n.touches[0].clientY);let e=new It(this.treatTouchEventsAsMouseEvents?"mousemove":"touchmove",n);this.interactiveObjects.forEach(t=>{this.dispatch(t,e)})});Ie(this,"onMouseClick",n=>{this.update();let e=new It("click",n);this.interactiveObjects.forEach(t=>{t.intersected&&this.dispatch(t,e)})});Ie(this,"onMouseDown",n=>{this.mapPositionToPoint(this.mouse,n.clientX,n.clientY),this.update();let e=new It("mousedown",n);this.interactiveObjects.forEach(t=>{t.intersected?(t.wasIntersectedOnMouseDown=!0,this.dispatch(t,e)):t.wasIntersectedOnMouseDown=!1})});Ie(this,"onPointerDown",n=>{this.mapPositionToPoint(this.mouse,n.clientX,n.clientY),this.update();let e=new It("pointerdown",n);this.interactiveObjects.forEach(t=>{t.intersected&&this.dispatch(t,e)})});Ie(this,"onTouchStart",n=>{n.touches.length>0&&this.mapPositionToPoint(this.mouse,n.touches[0].clientX,n.touches[0].clientY),this.update();let e=new It(this.treatTouchEventsAsMouseEvents?"mousedown":"touchstart",n);this.interactiveObjects.forEach(t=>{t.intersected&&this.dispatch(t,e)})});Ie(this,"onMouseUp",n=>{let e=new It("mouseup",n);this.interactiveObjects.forEach(t=>{this.dispatch(t,e)})});Ie(this,"onPointerUp",n=>{let e=new It("pointerup",n);this.interactiveObjects.forEach(t=>{this.dispatch(t,e)})});Ie(this,"onTouchEnd",n=>{n.touches.length>0&&this.mapPositionToPoint(this.mouse,n.touches[0].clientX,n.touches[0].clientY),this.update();let e=new It(this.treatTouchEventsAsMouseEvents?"mouseup":"touchend",n);this.interactiveObjects.forEach(t=>{this.dispatch(t,e)})});Ie(this,"dispatch",(n,e)=>{n.target&&!e.cancelBubble&&(e.coords=this.mouse,e.distance=n.distance,e.intersected=n.intersected,e.wasIntersected=n.wasIntersected,e.wasIntersectedOnMouseDown=n.wasIntersectedOnMouseDown,n.target.dispatchEvent(e))});Ie(this,"mapPositionToPoint",(n,e,t)=>{let i=this.renderer.domElement.getBoundingClientRect();n.x=(e-i.left)/i.width*2-1,n.y=-((t-i.top)/i.height)*2+1});this.renderer=n,this.camera=e,this.domElement=t,this.bindEventsOnBodyElement=i&&typeof i.bindEventsOnBodyElement<"u"?i.bindEventsOnBodyElement:!0,this.scene=i&&typeof i.scene<"u"?i.scene:null,this.scene&&(this.scene.onBeforeRender=()=>{this.autoAdd&&this.scene!==null&&this.scene.traverse(r=>{this.add(r),r.addEventListener("removed",s=>{this.remove(s.target)})}),this.update()}),this.autoAdd=i&&typeof i.autoAdd<"u"?i.autoAdd:!1,this.autoAdd&&this.scene===null&&console.error("Attention: Options.scene needs to be set when using options.autoAdd"),this.mouse=new Ge(-1,1),this.supportsPointerEvents=!!window.PointerEvent,this.interactiveObjects=[],this.closestObject=null,this.raycaster=new eb,t.addEventListener("click",this.onMouseClick),this.supportsPointerEvents&&(this.bindEventsOnBodyElement?t.ownerDocument.addEventListener("pointermove",this.onDocumentPointerMove):t.addEventListener("pointermove",this.onDocumentPointerMove),t.addEventListener("pointerdown",this.onPointerDown),t.addEventListener("pointerup",this.onPointerUp)),this.bindEventsOnBodyElement?t.ownerDocument.addEventListener("mousemove",this.onDocumentMouseMove):t.addEventListener("mousemove",this.onDocumentMouseMove),t.addEventListener("mousedown",this.onMouseDown),t.addEventListener("mouseup",this.onMouseUp),t.addEventListener("touchstart",this.onTouchStart,{passive:!0}),t.addEventListener("touchmove",this.onTouchMove,{passive:!0}),t.addEventListener("touchend",this.onTouchEnd,{passive:!0}),this.treatTouchEventsAsMouseEvents=!0}};const cu={type:"change"},$o={type:"start"},uu={type:"end"};class rb extends wi{constructor(e,t){super(),this.object=e,this.domElement=t,this.domElement.style.touchAction="none",this.enabled=!0,this.target=new N,this.minDistance=0,this.maxDistance=1/0,this.minZoom=0,this.maxZoom=1/0,this.minPolarAngle=0,this.maxPolarAngle=Math.PI,this.minAzimuthAngle=-1/0,this.maxAzimuthAngle=1/0,this.enableDamping=!1,this.dampingFactor=.05,this.enableZoom=!0,this.zoomSpeed=1,this.enableRotate=!0,this.rotateSpeed=1,this.enablePan=!0,this.panSpeed=1,this.screenSpacePanning=!0,this.keyPanSpeed=7,this.autoRotate=!1,this.autoRotateSpeed=2,this.keys={LEFT:"ArrowLeft",UP:"ArrowUp",RIGHT:"ArrowRight",BOTTOM:"ArrowDown"},this.mouseButtons={LEFT:Ti.ROTATE,MIDDLE:Ti.DOLLY,RIGHT:Ti.PAN},this.touches={ONE:Ai.ROTATE,TWO:Ai.DOLLY_PAN},this.target0=this.target.clone(),this.position0=this.object.position.clone(),this.zoom0=this.object.zoom,this._domElementKeyEvents=null,this.getPolarAngle=function(){return o.phi},this.getAzimuthalAngle=function(){return o.theta},this.getDistance=function(){return this.object.position.distanceTo(this.target)},this.listenToKeyEvents=function(A){A.addEventListener("keydown",de),this._domElementKeyEvents=A},this.stopListenToKeyEvents=function(){this._domElementKeyEvents.removeEventListener("keydown",de),this._domElementKeyEvents=null},this.saveState=function(){i.target0.copy(i.target),i.position0.copy(i.object.position),i.zoom0=i.object.zoom},this.reset=function(){i.target.copy(i.target0),i.object.position.copy(i.position0),i.object.zoom=i.zoom0,i.object.updateProjectionMatrix(),i.dispatchEvent(cu),i.update(),s=r.NONE},this.update=function(){const A=new N,F=new bi().setFromUnitVectors(e.up,new N(0,1,0)),ve=F.clone().invert(),ge=new N,Me=new bi,Ae=2*Math.PI;return function(){const Re=i.object.position;A.copy(Re).sub(i.target),A.applyQuaternion(F),o.setFromVector3(A),i.autoRotate&&s===r.NONE&&P(O()),i.enableDamping?(o.theta+=l.theta*i.dampingFactor,o.phi+=l.phi*i.dampingFactor):(o.theta+=l.theta,o.phi+=l.phi);let De=i.minAzimuthAngle,je=i.maxAzimuthAngle;return isFinite(De)&&isFinite(je)&&(De<-Math.PI?De+=Ae:De>Math.PI&&(De-=Ae),je<-Math.PI?je+=Ae:je>Math.PI&&(je-=Ae),De<=je?o.theta=Math.max(De,Math.min(je,o.theta)):o.theta=o.theta>(De+je)/2?Math.max(De,o.theta):Math.min(je,o.theta)),o.phi=Math.max(i.minPolarAngle,Math.min(i.maxPolarAngle,o.phi)),o.makeSafe(),o.radius*=c,o.radius=Math.max(i.minDistance,Math.min(i.maxDistance,o.radius)),i.enableDamping===!0?i.target.addScaledVector(u,i.dampingFactor):i.target.add(u),A.setFromSpherical(o),A.applyQuaternion(ve),Re.copy(i.target).add(A),i.object.lookAt(i.target),i.enableDamping===!0?(l.theta*=1-i.dampingFactor,l.phi*=1-i.dampingFactor,u.multiplyScalar(1-i.dampingFactor)):(l.set(0,0,0),u.set(0,0,0)),c=1,f||ge.distanceToSquared(i.object.position)>a||8*(1-Me.dot(i.object.quaternion))>a?(i.dispatchEvent(cu),ge.copy(i.object.position),Me.copy(i.object.quaternion),f=!1,!0):!1}}(),this.dispose=function(){i.domElement.removeEventListener("contextmenu",R),i.domElement.removeEventListener("pointerdown",C),i.domElement.removeEventListener("pointercancel",Y),i.domElement.removeEventListener("wheel",pe),i.domElement.removeEventListener("pointermove",B),i.domElement.removeEventListener("pointerup",ne),i._domElementKeyEvents!==null&&(i._domElementKeyEvents.removeEventListener("keydown",de),i._domElementKeyEvents=null)};const i=this,r={NONE:-1,ROTATE:0,DOLLY:1,PAN:2,TOUCH_ROTATE:3,TOUCH_PAN:4,TOUCH_DOLLY_PAN:5,TOUCH_DOLLY_ROTATE:6};let s=r.NONE;const a=1e-6,o=new au,l=new au;let c=1;const u=new N;let f=!1;const h=new Ge,d=new Ge,g=new Ge,p=new Ge,m=new Ge,v=new Ge,b=new Ge,_=new Ge,S=new Ge,E=[],L={};function O(){return 2*Math.PI/60/60*i.autoRotateSpeed}function M(){return Math.pow(.95,i.zoomSpeed)}function P(A){l.theta-=A}function U(A){l.phi-=A}const J=function(){const A=new N;return function(ve,ge){A.setFromMatrixColumn(ge,0),A.multiplyScalar(-ve),u.add(A)}}(),ce=function(){const A=new N;return function(ve,ge){i.screenSpacePanning===!0?A.setFromMatrixColumn(ge,1):(A.setFromMatrixColumn(ge,0),A.crossVectors(i.object.up,A)),A.multiplyScalar(ve),u.add(A)}}(),V=function(){const A=new N;return function(ve,ge){const Me=i.domElement;if(i.object.isPerspectiveCamera){const Ae=i.object.position;A.copy(Ae).sub(i.target);let Ce=A.length();Ce*=Math.tan(i.object.fov/2*Math.PI/180),J(2*ve*Ce/Me.clientHeight,i.object.matrix),ce(2*ge*Ce/Me.clientHeight,i.object.matrix)}else i.object.isOrthographicCamera?(J(ve*(i.object.right-i.object.left)/i.object.zoom/Me.clientWidth,i.object.matrix),ce(ge*(i.object.top-i.object.bottom)/i.object.zoom/Me.clientHeight,i.object.matrix)):(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - pan disabled."),i.enablePan=!1)}}();function z(A){i.object.isPerspectiveCamera?c/=A:i.object.isOrthographicCamera?(i.object.zoom=Math.max(i.minZoom,Math.min(i.maxZoom,i.object.zoom*A)),i.object.updateProjectionMatrix(),f=!0):(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),i.enableZoom=!1)}function Z(A){i.object.isPerspectiveCamera?c*=A:i.object.isOrthographicCamera?(i.object.zoom=Math.max(i.minZoom,Math.min(i.maxZoom,i.object.zoom/A)),i.object.updateProjectionMatrix(),f=!0):(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),i.enableZoom=!1)}function re(A){h.set(A.clientX,A.clientY)}function se(A){b.set(A.clientX,A.clientY)}function W(A){p.set(A.clientX,A.clientY)}function ae(A){d.set(A.clientX,A.clientY),g.subVectors(d,h).multiplyScalar(i.rotateSpeed);const F=i.domElement;P(2*Math.PI*g.x/F.clientHeight),U(2*Math.PI*g.y/F.clientHeight),h.copy(d),i.update()}function he(A){_.set(A.clientX,A.clientY),S.subVectors(_,b),S.y>0?z(M()):S.y<0&&Z(M()),b.copy(_),i.update()}function we(A){m.set(A.clientX,A.clientY),v.subVectors(m,p).multiplyScalar(i.panSpeed),V(v.x,v.y),p.copy(m),i.update()}function j(A){A.deltaY<0?Z(M()):A.deltaY>0&&z(M()),i.update()}function fe(A){let F=!1;switch(A.code){case i.keys.UP:A.ctrlKey||A.metaKey||A.shiftKey?U(2*Math.PI*i.rotateSpeed/i.domElement.clientHeight):V(0,i.keyPanSpeed),F=!0;break;case i.keys.BOTTOM:A.ctrlKey||A.metaKey||A.shiftKey?U(-2*Math.PI*i.rotateSpeed/i.domElement.clientHeight):V(0,-i.keyPanSpeed),F=!0;break;case i.keys.LEFT:A.ctrlKey||A.metaKey||A.shiftKey?P(2*Math.PI*i.rotateSpeed/i.domElement.clientHeight):V(i.keyPanSpeed,0),F=!0;break;case i.keys.RIGHT:A.ctrlKey||A.metaKey||A.shiftKey?P(-2*Math.PI*i.rotateSpeed/i.domElement.clientHeight):V(-i.keyPanSpeed,0),F=!0;break}F&&(A.preventDefault(),i.update())}function _e(){if(E.length===1)h.set(E[0].pageX,E[0].pageY);else{const A=.5*(E[0].pageX+E[1].pageX),F=.5*(E[0].pageY+E[1].pageY);h.set(A,F)}}function k(){if(E.length===1)p.set(E[0].pageX,E[0].pageY);else{const A=.5*(E[0].pageX+E[1].pageX),F=.5*(E[0].pageY+E[1].pageY);p.set(A,F)}}function be(){const A=E[0].pageX-E[1].pageX,F=E[0].pageY-E[1].pageY,ve=Math.sqrt(A*A+F*F);b.set(0,ve)}function I(){i.enableZoom&&be(),i.enablePan&&k()}function K(){i.enableZoom&&be(),i.enableRotate&&_e()}function q(A){if(E.length==1)d.set(A.pageX,A.pageY);else{const ve=xe(A),ge=.5*(A.pageX+ve.x),Me=.5*(A.pageY+ve.y);d.set(ge,Me)}g.subVectors(d,h).multiplyScalar(i.rotateSpeed);const F=i.domElement;P(2*Math.PI*g.x/F.clientHeight),U(2*Math.PI*g.y/F.clientHeight),h.copy(d)}function oe(A){if(E.length===1)m.set(A.pageX,A.pageY);else{const F=xe(A),ve=.5*(A.pageX+F.x),ge=.5*(A.pageY+F.y);m.set(ve,ge)}v.subVectors(m,p).multiplyScalar(i.panSpeed),V(v.x,v.y),p.copy(m)}function Se(A){const F=xe(A),ve=A.pageX-F.x,ge=A.pageY-F.y,Me=Math.sqrt(ve*ve+ge*ge);_.set(0,Me),S.set(0,Math.pow(_.y/b.y,i.zoomSpeed)),z(S.y),b.copy(_)}function Te(A){i.enableZoom&&Se(A),i.enablePan&&oe(A)}function w(A){i.enableZoom&&Se(A),i.enableRotate&&q(A)}function C(A){i.enabled!==!1&&(E.length===0&&(i.domElement.setPointerCapture(A.pointerId),i.domElement.addEventListener("pointermove",B),i.domElement.addEventListener("pointerup",ne)),X(A),A.pointerType==="touch"?y(A):ee(A))}function B(A){i.enabled!==!1&&(A.pointerType==="touch"?x(A):ue(A))}function ne(A){$(A),E.length===0&&(i.domElement.releasePointerCapture(A.pointerId),i.domElement.removeEventListener("pointermove",B),i.domElement.removeEventListener("pointerup",ne)),i.dispatchEvent(uu),s=r.NONE}function Y(A){$(A)}function ee(A){let F;switch(A.button){case 0:F=i.mouseButtons.LEFT;break;case 1:F=i.mouseButtons.MIDDLE;break;case 2:F=i.mouseButtons.RIGHT;break;default:F=-1}switch(F){case Ti.DOLLY:if(i.enableZoom===!1)return;se(A),s=r.DOLLY;break;case Ti.ROTATE:if(A.ctrlKey||A.metaKey||A.shiftKey){if(i.enablePan===!1)return;W(A),s=r.PAN}else{if(i.enableRotate===!1)return;re(A),s=r.ROTATE}break;case Ti.PAN:if(A.ctrlKey||A.metaKey||A.shiftKey){if(i.enableRotate===!1)return;re(A),s=r.ROTATE}else{if(i.enablePan===!1)return;W(A),s=r.PAN}break;default:s=r.NONE}s!==r.NONE&&i.dispatchEvent($o)}function ue(A){switch(s){case r.ROTATE:if(i.enableRotate===!1)return;ae(A);break;case r.DOLLY:if(i.enableZoom===!1)return;he(A);break;case r.PAN:if(i.enablePan===!1)return;we(A);break}}function pe(A){i.enabled===!1||i.enableZoom===!1||s!==r.NONE||(A.preventDefault(),i.dispatchEvent($o),j(A),i.dispatchEvent(uu))}function de(A){i.enabled===!1||i.enablePan===!1||fe(A)}function y(A){switch(le(A),E.length){case 1:switch(i.touches.ONE){case Ai.ROTATE:if(i.enableRotate===!1)return;_e(),s=r.TOUCH_ROTATE;break;case Ai.PAN:if(i.enablePan===!1)return;k(),s=r.TOUCH_PAN;break;default:s=r.NONE}break;case 2:switch(i.touches.TWO){case Ai.DOLLY_PAN:if(i.enableZoom===!1&&i.enablePan===!1)return;I(),s=r.TOUCH_DOLLY_PAN;break;case Ai.DOLLY_ROTATE:if(i.enableZoom===!1&&i.enableRotate===!1)return;K(),s=r.TOUCH_DOLLY_ROTATE;break;default:s=r.NONE}break;default:s=r.NONE}s!==r.NONE&&i.dispatchEvent($o)}function x(A){switch(le(A),s){case r.TOUCH_ROTATE:if(i.enableRotate===!1)return;q(A),i.update();break;case r.TOUCH_PAN:if(i.enablePan===!1)return;oe(A),i.update();break;case r.TOUCH_DOLLY_PAN:if(i.enableZoom===!1&&i.enablePan===!1)return;Te(A),i.update();break;case r.TOUCH_DOLLY_ROTATE:if(i.enableZoom===!1&&i.enableRotate===!1)return;w(A),i.update();break;default:s=r.NONE}}function R(A){i.enabled!==!1&&A.preventDefault()}function X(A){E.push(A)}function $(A){delete L[A.pointerId];for(let F=0;F<E.length;F++)if(E[F].pointerId==A.pointerId){E.splice(F,1);return}}function le(A){let F=L[A.pointerId];F===void 0&&(F=new Ge,L[A.pointerId]=F),F.set(A.pageX,A.pageY)}function xe(A){const F=A.pointerId===E[0].pointerId?E[1]:E[0];return L[F.pointerId]}i.domElement.addEventListener("contextmenu",R),i.domElement.addEventListener("pointerdown",C),i.domElement.addEventListener("pointercancel",Y),i.domElement.addEventListener("wheel",pe,{passive:!1}),this.update()}}const ki=new N,fu=new lt,hu=new lt,du=new N,pu=new N;class sb{constructor(e={}){const t=this;let i,r,s,a;const o={objects:new WeakMap},l=e.element!==void 0?e.element:document.createElement("div");l.style.overflow="hidden",this.domElement=l,this.getSize=function(){return{width:i,height:r}},this.render=function(d,g){d.matrixWorldAutoUpdate===!0&&d.updateMatrixWorld(),g.parent===null&&g.matrixWorldAutoUpdate===!0&&g.updateMatrixWorld(),fu.copy(g.matrixWorldInverse),hu.multiplyMatrices(g.projectionMatrix,fu),c(d,d,g),h(d)},this.setSize=function(d,g){i=d,r=g,s=i/2,a=r/2,l.style.width=d+"px",l.style.height=g+"px"};function c(d,g,p){if(d.isCSS2DObject){ki.setFromMatrixPosition(d.matrixWorld),ki.applyMatrix4(hu);const m=d.visible===!0&&ki.z>=-1&&ki.z<=1&&d.layers.test(p.layers)===!0;if(d.element.style.display=m===!0?"":"none",m===!0){d.onBeforeRender(t,g,p);const b=d.element;b.style.transform="translate(-50%,-50%) translate("+(ki.x*s+s)+"px,"+(-ki.y*a+a)+"px)",b.parentNode!==l&&l.appendChild(b),d.onAfterRender(t,g,p)}const v={distanceToCameraSquared:u(p,d)};o.objects.set(d,v)}for(let m=0,v=d.children.length;m<v;m++)c(d.children[m],g,p)}function u(d,g){return du.setFromMatrixPosition(d.matrixWorld),pu.setFromMatrixPosition(g.matrixWorld),du.distanceToSquared(pu)}function f(d){const g=[];return d.traverse(function(p){p.isCSS2DObject&&g.push(p)}),g}function h(d){const g=f(d).sort(function(m,v){if(m.renderOrder!==v.renderOrder)return v.renderOrder-m.renderOrder;const b=o.objects.get(m).distanceToCameraSquared,_=o.objects.get(v).distanceToCameraSquared;return b-_}),p=g.length;for(let m=0,v=g.length;m<v;m++)g[m].element.style.zIndex=p-m}}}const ob=""+new URL("stars_milky_way-1fd005dd.jpg",import.meta.url).href,ab=""+new URL("earth_daymap-88ab060b.jpg",import.meta.url).href,lb=""+new URL("earth_normal_map-051f36fb.jpg",import.meta.url).href,cb=""+new URL("earth_nightmap-9894e83a.jpg",import.meta.url).href,ub=""+new URL("earth_specular_map-d8aefc72.jpg",import.meta.url).href,fb=""+new URL("moon_map-d1875bce.jpg",import.meta.url).href;class hb{constructor(e,t,i,r,s){this.size=e,this.parent=t,this.atmosphereUniforms=s,this.atmosphereVertexShader=i,this.atmosphereFragmentShader=r,this.atmosphereGeometry=new Ks(this.size,32,32),this.atmosphere=new vn(this.atmosphereGeometry,new oh({uniforms:this.atmosphereUniforms,vertexShader:i,fragmentShader:r,side:Ft,blending:ha,transparent:!0})),this.parent.mesh.add(this.atmosphere)}update(){this.atmosphere.rotation.y-=this.parent.rotationSpeed}}class Ms{constructor(e,t,i,r,s,a,o,l,c,u,f,h){this.name=e,this.radius=t,this.orbit=i,this.position=r,this.tilt=s,this.rotationSpeed=a,this.orbitSpeed=o,this.uniforms=u,this.geometry=new Ks(this.radius,32,32),this.material=new oh({uniforms:this.uniforms,vertexShader:l,fragmentShader:c}),this.mesh=new vn(this.geometry,this.material),this.mesh.name=this.name,this.mesh.position.set(this.position.x,this.position.y,this.position.z),h?this.parent=h:this.parent=null,f?this.scene=f:this.scene=null,this.addEventListeners()}showAxishelper(){const e=new nb(3+this.radius);this.mesh.add(e)}setSolarSystem(e){this.solarSystem=e}getMesh(){return this.mesh}rotate(){this.mesh.rotation.y+=this.rotationSpeed}rotateOrbit(){this.orbitObject&&(this.orbitObject.rotation.y+=this.orbitSpeed)}setOrbitObject(e){this.orbitObject=e}addToParent(e){this.parent=e,this.parent.mesh.add(this.mesh)}addToScene(e){this.scene=e,this.scene.add(this.mesh)}addAtmosphere(e,t,i,r){this.atmosphere=new hb(e,this,t,i,r)}addEventListeners(){this.name==="earth"&&this.mesh.addEventListener("click",()=>{console.log(this.name),this.solarSystem&&this.solarSystem.getCurrentPlanet()!==this.name?this.solarSystem.setCurrentPlanet(this.name):this.solarSystem&&this.solarSystem.getCurrentPlanet()===this.name&&this.solarSystem.setCurrentPlanet(null)}),this.mesh.addEventListener("mouseover",()=>{}),this.mesh.addEventListener("mouseout",()=>{})}update(e){this.rotate(),this.rotateOrbit()}}class db{constructor(e,t,i,r,s,a,o,l,c,u){this.position=new N(0,0,0),this.name=e,this.scene=t,this.target=i,this.parent=r,this.fov=o,this.aspect=l,this.near=c,this.far=u,this.offset=s,this.camera=new Wt(this.fov,this.aspect,this.near,this.far),this.camera.name=this.name,this.camera.position.copy(this.position.copy(this.parent.position).add(this.offset)),this.camera.lookAt(this.position.copy(this.target.position).add(a)),r.add(this.camera)}show(){const e=new tb(this.camera);this.scene.add(e)}}function pb(n){const e=new sb;return e.setSize(window.innerWidth,window.innerHeight),e.domElement.style.position="absolute",e.domElement.style.top="0px",e.domElement.style.pointerEvents="none",e.domElement.className="css2dRenderer",n.appendChild(e.domElement),e}const mb=new N(120,10,25),gb=new N(0,0,10);var lh=(n=>(n.earth="earth",n.sun="sun",n.moon="moon",n))(lh||{});function _b(n){const e=new Zy;return e.background=n,e}function vb(n,e,t){const i=new qa({canvas:t,antialias:!0});i.setSize(window.innerWidth,window.innerHeight),i.setPixelRatio(window.devicePixelRatio);const r=new rb(e,i.domElement);return r.rotateSpeed=1,r.zoomSpeed=1.2,r.enableZoom=!0,r.keys={LEFT:"KeyA",UP:"KeyW",RIGHT:"KeyD",BOTTOM:"KeyS"},r.minDistance=.1,r.maxDistance=1e3,i}function xb(n){const e=new Wt(75,window.innerWidth/window.innerHeight,.1,1e6);return e.position.set(-48,69,-50),e.name="camera",n.add(e),e}function yb(n,e){return new db("earthCamera",n,e,e.orbitObject,mb,gb,50,window.innerWidth/window.innerHeight,.1,100)}var bb=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function Mb(n){return n&&n.__esModule&&Object.prototype.hasOwnProperty.call(n,"default")?n.default:n}var ch={exports:{}};(function(n,e){(function(t,i){n.exports=i()})(bb,function(){var t=function(){function i(d){return a.appendChild(d.dom),d}function r(d){for(var g=0;g<a.children.length;g++)a.children[g].style.display=g===d?"block":"none";s=d}var s=0,a=document.createElement("div");a.style.cssText="position:fixed;top:0;left:0;cursor:pointer;opacity:0.9;z-index:10000",a.addEventListener("click",function(d){d.preventDefault(),r(++s%a.children.length)},!1);var o=(performance||Date).now(),l=o,c=0,u=i(new t.Panel("FPS","#0ff","#002")),f=i(new t.Panel("MS","#0f0","#020"));if(self.performance&&self.performance.memory)var h=i(new t.Panel("MB","#f08","#201"));return r(0),{REVISION:16,dom:a,addPanel:i,showPanel:r,begin:function(){o=(performance||Date).now()},end:function(){c++;var d=(performance||Date).now();if(f.update(d-o,200),d>l+1e3&&(u.update(1e3*c/(d-l),100),l=d,c=0,h)){var g=performance.memory;h.update(g.usedJSHeapSize/1048576,g.jsHeapSizeLimit/1048576)}return d},update:function(){o=this.end()},domElement:a,setMode:r}};return t.Panel=function(i,r,s){var a=1/0,o=0,l=Math.round,c=l(window.devicePixelRatio||1),u=80*c,f=48*c,h=3*c,d=2*c,g=3*c,p=15*c,m=74*c,v=30*c,b=document.createElement("canvas");b.width=u,b.height=f,b.style.cssText="width:80px;height:48px";var _=b.getContext("2d");return _.font="bold "+9*c+"px Helvetica,Arial,sans-serif",_.textBaseline="top",_.fillStyle=s,_.fillRect(0,0,u,f),_.fillStyle=r,_.fillText(i,h,d),_.fillRect(g,p,m,v),_.fillStyle=s,_.globalAlpha=.9,_.fillRect(g,p,m,v),{dom:b,update:function(S,E){a=Math.min(a,S),o=Math.max(o,S),_.fillStyle=s,_.globalAlpha=1,_.fillRect(0,0,u,p),_.fillStyle=r,_.fillText(l(S)+" "+i+" ("+l(a)+"-"+l(o)+")",h,d),_.drawImage(b,g+c,p,m-c,v,g,p,m-c,v),_.fillRect(g+m-c,p,c,v),_.fillStyle=s,_.globalAlpha=.9,_.fillRect(g+m-c,p,c,l((1-S/E)*v))}}},t})})(ch);var Sb=ch.exports;const wb=Mb(Sb),Eb=""+new URL("gameplanet_map-d94c950d.jpg",import.meta.url).href,Tb=`#version 300 es \r
\r
